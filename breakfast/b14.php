...
<title>Aloo Sandwich | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Aloo Sandwich</h1>
  <div class="food-img">
 <img src="/food_recipe/food_image/break/bk14.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="bk14">  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>4 ಬ್ರೆಡ್ ಸ್ಲೈಸ್‌ಗಳು</li>
      <li>1 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಬೆಣ್ಣೆ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಚಾಟ್ ಮಸಾಲಾ</li>
    ...
    <ol data-lang="en">
      <li>Mash potatoes and mix with spices and green chili.</li>
      <li>Spread filling on bread slices.</li>
      <li>Grill or toast with butter until golden brown.</li>
      <li>Serve hot with ketchup or chutney.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಆಲೂಗಡ್ಡೆ ಮ್ಯಾಷ್ ಮಾಡಿ ಮಸಾಲೆ ಮತ್ತು ಹಸಿಮೆಣಸು ಸೇರಿಸಿ.</li>
      <li>ಬ್ರೆಡ್ ಮೇಲೆ ಮಿಶ್ರಣ ಹಚ್ಚಿ.</li>
      <li>ಬೆಣ್ಣೆಯೊಂದಿಗೆ ಬಂಗಾರದ ಬಣ್ಣ ಬರುವವರೆಗೆ ಗ್ರಿಲ್ ಮಾಡಿ.</li>
      <li>ಕೆಚಪ್ ಅಥವಾ ಚಟ್ನಿಯೊಂದಿಗೆ ಬಿಸಿ ಬಿಸಿ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>

    <h2 data-lang="en">Nutrition (per sandwich)</h2>
    <table data-lang="en">
...
const recipeData={id:78,name:"Aloo Sandwich",link:"breakfast/b14.php",image:"../food_image/snacks/aloo_sandwich.jpg"};

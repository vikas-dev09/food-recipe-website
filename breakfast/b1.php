...
<div class="container">
  ...
  <img src="/food_recipe/food_image/break/bk1.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="bk1">
</div>  
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಅಕ್ಕಿ</li>
      <li>1/2 ಕಪ್ ಉದ್ದಿನ ಬೇಳೆ</li>
      <li>ರುಚಿಗೆ ತಕ್ಕ ಉಪ್ಪು</li>
      <li>ಅವಶ್ಯಕತೆ ಇದ್ದಷ್ಟು ನೀರು</li>
      <li>ತಟ್ಟೆಗೆ ಎಣ್ಣೆ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Idli</h2>
    <h2 data-lang="kn" style="display:none;">ಇಡ್ಲಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Soak rice and urad dal separately for 4-5 hours.</li>
      <li>Grind both to a smooth batter and mix together.</li>
      <li>Ferment overnight.</li>
      <li>Grease idli plates, pour batter, and steam for 10-12 minutes.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಅಕ್ಕಿ ಮತ್ತು ಉದ್ದಿನ ಬೇಳೆ ಬೇರೆ ಬೇರೆ 4–5 ಗಂಟೆ ನೆನೆಸಿ.</li>
      <li>ಇವುಗಳನ್ನು ಸೊಪ್ಪಾಗುವವರೆಗೆ ರುಬ್ಬಿ ಬೆರೆಸಿ.</li>
      <li>ರಾತ್ರಿ ಪೂರ್ತಿ ಹುರಿಯಲು ಬಿಡಿ.</li>
      <li>ಇಡ್ಲಿ ತಟ್ಟೆ ಎಣ್ಣೆ ಹಚ್ಚಿ, ಹಿಟ್ಟು ಸುರಿದು 10–12 ನಿಮಿಷ ಬಾಡಿಸಿ.</li>
    </ol>

    <h2 data-lang="en">Nutrition Information (per 2 idlis)</h2>
    <h2 data-lang="kn" style="display:none;">ಪೌಷ್ಟಿಕ ಮಾಹಿತಿ (ಪ್ರತಿ 2 ಇಡ್ಲಿಗಳು)</h2>
    <table data-lang="en">
    ...
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಕಾರ್ಬೊಹೈಡ್ರೇಟ್</td><td>22 g</td></tr>
...
<script>
  ...
  const recipeData = { id: 65, name: "Idli", link: "breakfast/b1.php", image: "../food_image/south/idli.jpg" };

...
<div class="container">
  ...
  <h1>Medu Vada</h1>
<div class="card">
  <img src="/food_recipe/food_image/break/bk8.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="bk8">
</div> 
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>Few curry leaves, salt to taste</li>
      <li>Oil for deep frying</li>
    </ul>
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಉದ್ದಿನ ಬೇಳೆ</li>
      <li>1 ಹಸಿಮೆಣಸು, ಸಣ್ಣದಾಗಿ ಕತ್ತರಿಸಿದ</li>
      <li>1 ಇಂಚು ಶುಂಠಿ, ಸಣ್ಣದಾಗಿ ಕತ್ತರಿಸಿದ</li>
      <li>ಕರಿಬೇವು ಎಲೆಗಳು, ಉಪ್ಪು ರುಚಿಗೆ</li>
      <li>ಹುರಿಯಲು ಎಣ್ಣೆ</li>
    </ul>
    ...
    <ol data-lang="en">
      <li>Soak urad dal for 4 hours and grind to a smooth, thick batter.</li>
      <li>Add salt, ginger, green chili, and curry leaves; mix well.</li>
      <li>Wet hands, shape the batter into rings.</li>
      <li>Deep fry until golden and crisp.</li>
      <li>Serve hot with coconut chutney and sambar.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಉದ್ದಿನ ಬೇಳೆ 4 ಗಂಟೆ ನೆನೆಸಿಟ್ಟು ಮೃದುವಾದ ಮಿಶ್ರಣ ಮಾಡಿ.</li>
      <li>ಉಪ್ಪು, ಶುಂಠಿ, ಹಸಿಮೆಣಸು, ಕರಿಬೇವು ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಕಲಸಿ.</li>
      <li>ಕೈ ತೇವಗೊಳಿಸಿ ವಡೆ ಆಕಾರಕ್ಕೆ ಮಾಡಿ.</li>
      <li>ಬಿಸಿ ಎಣ್ಣೆಯಲ್ಲಿ ಬಂಗಾರದ ಬಣ್ಣ ಬರುವವರೆಗೆ ಹುರಿಯಿರಿ.</li>
      <li>ತೆಂಗಿನ ಚಟ್ನಿ ಮತ್ತು ಸಾಂಬಾರ್ ಜೊತೆಗೆ ಬಿಸಿ ಬಿಸಿ ಸೇವಿಸಿ.</li>
    </ol>

    <h2 data-lang="en">Nutrition Info (per 2 pieces)</h2>
    <table data-lang="en">
      <tr><th>Nutrient</th><th>Amount</th></tr>
      <tr><td>Calories</td><td>280 kcal</td></tr>
      <tr><td>Protein</td><td>9 g</td></tr>
      <tr><td>Carbs</td><td>24 g</td></tr>
...
const recipeData={id:72,name:"Medu Vada",link:"breakfast/b8.php",image:"../food_image/south/medu_vada.jpg"};

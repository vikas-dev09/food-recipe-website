...
<div class="container">
  ...
  <h1>Dhokla</h1>
  <div class="food-img">
  <img src="/food_recipe/food_image/break/bk15.jpg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="bk15">  </div>
  ...
  <div id="recipe-content">
    ...
    <ol data-lang="en">
      <li>Mix besan, curd, lemon juice, salt, and sugar to form batter.</li>
      <li>Add eno just before steaming and mix gently.</li>
      <li>Steam for 15 minutes until soft and spongy.</li>
      <li>Temper with mustard seeds and curry leaves, pour over dhokla.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಕಡಲೆಹಿಟ್ಟು, ಮೊಸರು, ನಿಂಬೆ ರಸ, ಉಪ್ಪು, ಸಕ್ಕರೆ ಸೇರಿಸಿ ಪೇಸ್ಟ್ ಮಾಡಿ.</li>
      <li>ಬಾಡಿಸಲು ಮುಂಚೆ ಈನೋ ಸೇರಿಸಿ.</li>
      <li>15 ನಿಮಿಷ ಬಾಡಿಸಿ ಮೃದುವಾಗುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
      <li>ಸಾಸಿವೆ ಮತ್ತು ಕರಿಬೇವು ತಡಕಿಸಿ ಮೇಲಿಟ್ಟು.</li>
    </ol>

    <h2 data-lang="en">Nutrition (per 100g)</h2>
    <table data-lang="en">
      <tr><th>Nutrient</th><th>Amount</th></tr>
      <tr><td>Calories</td><td>160 kcal</td></tr>
      <tr><td>Protein</td><td>6 g</td></tr>
      <tr><td>Carbs</td><td>22 g</td></tr>
...
const recipeData={id:79,name:"Dhokla",link:"breakfast/b15.php",image:"../food_image/gujarati/dhokla.jpg"};

...
<title>Masala Dosa | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Masala Dosa</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/break/bk9.jpeg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="bk9">  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>Salt to taste</li>
      <li>2 tbsp oil</li>
      <li>Curry leaves and coriander</li>
    </ul>
    <ul data-lang="kn" style="display:none;">
      <li>2 ಕಪ್ ದೋಸೆ ಹಿಟ್ಟು</li>
      <li>2 ಬೇಯಿಸಿದ ಆಲೂಗಡ್ಡೆ (ಮ್ಯಾಶ್ ಮಾಡಿದ)</li>
      <li>1 ಈರುಳ್ಳಿ (ಸ್ಲೈಸ್ ಮಾಡಿದ)</li>
      <li>1 ಹಸಿಮೆಣಸು (ಕತ್ತರಿಸಿದ)</li>
      <li>1/2 ಟೀ ಸ್ಪೂನ್ ಸಾಸಿವೆ</li>
      <li>1/4 ಟೀ ಸ್ಪೂನ್ ಅರಿಶಿನ</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ ತಕ್ಕಷ್ಟು</li>
      <li>2 ಟೇಬಲ್ ಸ್ಪೂನ್ ಎಣ್ಣೆ</li>
      <li>ಕರಿಬೇವು ಮತ್ತು ಕೊತ್ತಂಬರಿ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Masala Dosa</h2>
    <h2 data-lang="kn" style="display:none;">ಮಸಾಲೆ ದೋಸೆ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat oil, add mustard seeds, curry leaves, and onions.</li>
      <li>Add green chili, turmeric, and mashed potatoes. Mix well.</li>
      <li>Spread dosa batter on a hot pan, drizzle oil.</li>
      <li>Place potato masala in the center and fold the dosa.</li>
      <li>Serve hot with coconut chutney and sambar.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ ಸಾಸಿವೆ, ಕರಿಬೇವು, ಈರುಳ್ಳಿ ಹಾಕಿ ಹುರಿಯಿರಿ.</li>
      <li>ಹಸಿಮೆಣಸು, ಅರಿಶಿನ, ಆಲೂಗಡ್ಡೆ ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಕಲಸಿ.</li>
      <li>ದೋಸೆ ಹಿಟ್ಟನ್ನು ಬಿಸಿ ತವೆಯ ಮೇಲೆ ಹಚ್ಚಿ ಎಣ್ಣೆ ಸುರಿಯಿರಿ.</li>
      <li>ಮಧ್ಯದಲ್ಲಿ ಮಸಾಲೆ ಇಟ್ಟು ದೋಸೆ ಮಡಿಸಿ.</li>
      <li>ತೆಂಗಿನ ಚಟ್ನಿ ಮತ್ತು ಸಾಂಬಾರದೊಂದಿಗೆ ಬಿಸಿ ಬಿಸಿ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 73, name: "Masala Dosa", link: "breakfast/b9.php", image: "../food_image/breakfast/masala_dosa.jpg" };

...
<div class="container">
  ...
  <h1>Poha</h1>
  <div class="food-img">
  <img src="/food_recipe/food_image/break/bk4.jpg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="bk4">
</div>  
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>1 ಹಸಿಮೆಣಸಿನಕಾಯಿ, ಕತ್ತರಿಸಿದ</li>
    ...
    <h2 data-lang="kn" style="display:none;">ಪೋಹಾ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Rinse poha in water and drain.</li>
      <li>Heat oil, add mustard seeds, onions, and chilies.</li>
      <li>Add poha, salt, and lemon juice.</li>
      <li>Mix gently and cook for 3-4 minutes.</li>
      <li>Serve warm with tea or chutney.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಅವಲಕ್ಕಿಯನ್ನು ನೀರಿನಲ್ಲಿ ತೊಳೆಯಿರಿ ಮತ್ತು ನೀರು ಕಳೆಯಿರಿ.</li>
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ, ಸಾಸಿವೆ, ಈರುಳ್ಳಿ, ಮೆಣಸಿನಕಾಯಿ ಸೇರಿಸಿ.</li>
      <li>ಅವಲಕ್ಕಿ, ಉಪ್ಪು ಮತ್ತು ನಿಂಬೆ ರಸ ಸೇರಿಸಿ.</li>
      <li>ಮೃದುವಾಗಿ ಕಲಸಿ 3-4 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಚಹಾ ಅಥವಾ ಚಟ್ನಿ ಜೊತೆಗೆ ಬಿಸಿ ಬಿಸಿ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
...
const recipeData={id:68,name:"Poha",link:"breakfast/b4.php",image:"../food_image/breakfast/poha.jpg"};

...
<title>Paneer Butter Masala | Foodies</title>
<style>
...
<div class="container">
  ...
  <div class="food-img">
<img src="/food_recipe/food_image/vegs/veg3.jpeg" style="width:300px;height:300px;object-fit:cover;box-shadow:0 4px 8px rgba(0,0,0,1.3);">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>Salt to taste</li>
      <li>Fresh cream & coriander</li>
    </ul>
    <ul data-lang="kn" style="display:none;">
      <li>200g ಪನೀರ್ ಕ್ಯೂಬ್</li>
      ...
      <li>ತಾಜಾ ಕ್ರೀಮ್ ಮತ್ತು ಕೊತ್ತಂಬರಿ</li>
    </ul>

    <h2 data-lang="en">Steps</h2>
    <h2 data-lang="kn" style="display:none;">ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat butter, sauté onions until golden.</li>
      <li>Add tomato puree, spices, cook 5 min.</li>
      <li>Add paneer cubes and cook 5–7 min.</li>
      <li>Add cream, mix, simmer 2 min.</li>
      <li>Garnish with coriander and serve.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಬೆಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ ಈರುಳ್ಳಿ ಹುರಿ.</li>
      <li>ಟೊಮೆಟೋ ಪ್ಯೂರಿ, ಮಸಾಲಾ ಸೇರಿಸಿ 5 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಪನೀರ್ ಕ್ಯೂಬ್ ಸೇರಿಸಿ 5–7 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಕ್ರೀಮ್ ಸೇರಿಸಿ ಮಿಶ್ರಣ ಮಾಡಿ 2 ನಿಮಿಷ ಕುಡಿಸಿ.</li>
...
const recipeData={id:115,name:"Paneer Butter Masala",link:"veg/v3.php",image:"../food_image/recipes/paneer_butter_masala.jpg"};

...
<title>Roti with Mixed Veg Curry | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Roti with Mixed Veg Curry</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegs/veg15.jpg" style="width:300px;height:300px;object-fit:cover;box-shadow:0 4px 8px rgba(0,0,0,1.3);">
  </div>
  ...
  <div id="recipe-content">
    ...
    <h2 data-lang="en">Steps to Make Roti with Mixed Veg Curry</h2>
    <h2 data-lang="kn" style="display:none;">ರೊಟ್ಟಿ ಮಿಶ್ರಿತ ತರಕಾರಿ ಕರಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Prepare dough for roti and set aside.</li>
      <li>Heat oil, add cumin seeds, turmeric, and vegetables. Cook for 5-7 minutes.</li>
      <li>Roll out rotis and cook on a hot griddle.</li>
      <li>Serve rotis hot with vegetable curry.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ರೊಟ್ಟಿ ಹಿಟ್ಟನ್ನು ತಯಾರಿಸಿ ಬದಿಗೆ ಇಡಿ.</li>
      <li>ಎಣ್ಣೆ ಬಿಸಿಲು ಮಾಡಿ, ಜೀರಿಗೆ, ಹಳದಿ, ಮತ್ತು ತರಕಾರಿಗಳನ್ನು ಹಾಕಿ. 5-7 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ರೊಟ್ಟಿಗಳನ್ನು ರೋಲ್ ಮಾಡಿ ಹಾಟ್ ಗ್ರಿಡಲ್ ಮೇಲೆ ಬೇಯಿಸಿ.</li>
      <li>ರೊಟ್ಟಿಗಳನ್ನು ತರಕಾರಿ ಕರಿ ಜೊತೆಗೆ ಬಿಸಿಯಾಗಿ ಸೇವಿಸಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 125, name: "Roti with Mixed Veg Curry", link: "veg/v13.php", image: "../food_image/recipes/roti_veg.jpg" };

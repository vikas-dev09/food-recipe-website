...
<title>Dal | Foodies</title>
<style>
/* Same CSS as your previous template */
...
<div class="container">
  ...
  <h1>Dal</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegs/veg1.jpg"
     style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ತುರ್ ಡಾಲ್</li>
      <li>2 ಕಪ್ ನೀರು</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಹಳದಿ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಜೀರಿಗೆ</li>
      <li>1 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಎಣ್ಣೆ/ಘೀ</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ ತಕ್ಕಂತೆ</li>
      <li>ಹಸಿರು ಕೊತ್ತಂಬರಿ ಅಲಂಕರಿಸಲು</li>
    </ul>

    <h2 data-lang="en">Steps</h2>
    <h2 data-lang="kn" style="display:none;">ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Wash dal and soak for 15 min.</li>
      <li>Boil dal with turmeric and water until soft.</li>
      <li>Heat ghee/oil, add cumin seeds for tempering.</li>
      <li>Pour tempering over dal and mix.</li>
      <li>Garnish with coriander and serve.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಡಾಲ್ ತೊಳಸಿ 15 ನಿಮಿಷ ನೆನೆಸಿಡಿ.</li>
      <li>ಹಳದಿ ಮತ್ತು ನೀರಿನೊಂದಿಗೆ ಬೇಯಿಸಿ.</li>
      <li>ಎಣ್ಣೆ/ಘೀ ಬಿಸಿ ಮಾಡಿ ಜೀರಿಗೆ ಹಾಕಿ.</li>
      <li>ಡಾಲ್ ಮೇಲೆ ತಂಪರಿಂಗ್ ಹಾಕಿ ಮಿಶ್ರಣ ಮಾಡಿ.</li>
      <li>ಕೊತ್ತಂಬರಿ ಅಲಂಕರಿಸಿ ಬಿಸಿಯಾಗಿ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
...
const recipeData = { id:113, name:"Dal", link:"veg/v1.php", image:"../food_image/recipes/dal.jpg" };

...
<div class="container">
  ...
  <h1>Khichdi</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegs/veg13.jpg" style="width:300px;height:300px;object-fit:cover;box-shadow:0 4px 8px rgba(0,0,0,1.3);">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>Salt to taste</li>
      <li>Optional: vegetables (carrot, peas, beans)</li>
    </ul>
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಅಕ್ಕಿ</li>
      <li>1/2 ಕಪ್ ಮುಂಗ್ ದಾಲ್</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಹಳದಿ ಪುಡಿ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಎಣ್ಣೆ ಅಥವಾ ಘೀ</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ ತಕ್ಕಂತೆ</li>
      <li>ಐಚ್ಛಿಕ: ತರಕಾರಿಗಳು (ಕಾರಟ್, ಪೀಸ್, ಬೀನ್ಸ್)</li>
    </ul>

    <h2 data-lang="en">Steps to Make Khichdi</h2>
    <h2 data-lang="kn" style="display:none;">ಖಿಚ್ಡಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Wash rice and dal thoroughly.</li>
      <li>Heat ghee/oil in a pot, add turmeric and rice-dal mixture.</li>
      <li>Add 2-3 cups water and vegetables (optional), cook until soft.</li>
      <li>Serve hot with yogurt or pickle.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಅಕ್ಕಿ ಮತ್ತು ದಾಲ್ ಚೆನ್ನಾಗಿ ತೊಳಸಿ.</li>
      <li>ಒಂದು ಪ್ಯಾನ್‌ನಲ್ಲಿ ಎಣ್ಣೆ/ಘೀ ಬಿಸಿಲು ಮಾಡಿ, ಹಳದಿ ಮತ್ತು ಅಕ್ಕಿ-ದಾಲ್ ಮಿಶ್ರಣವನ್ನು ಹಾಕಿ.</li>
      <li>2-3 ಕಪ್ ನೀರು ಮತ್ತು ತರಕಾರಿಗಳನ್ನು (ಐಚ್ಛಿಕ) ಸೇರಿಸಿ, ಮೃದುವಾಗುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
...
<script>
  ...
  const recipeData = { id: 127, name: "Khichdi", link: "veg/v15.php", image: "../food_image/recipes/khichdi.jpg" };

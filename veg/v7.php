...
<title>Vegetable Pulao | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Vegetable Pulao</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegs/veg7.jpg"  style="width:300px;height:300px;object-fit:cover;box-shadow:0 4px 8px rgba(0,0,0,1.3);">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>1 ಕಪ್ ಮಿಶ್ರಿತ ತರಕಾರಿಗಳು (ಕಾರಟ್, ಬೀನ್ಸ್, ಪೀಸ್)</li>
      <li>1 ಈರುಳ್ಳಿ, ಕತ್ತರಿಸಿದ</li>
      <li>2 ಟೀಸ್ಪೂನ್ ಎಣ್ಣೆ ಅಥವಾ ಘೀ</li>
    ...
    <h2 data-lang="en">Steps to Make Vegetable Pulao</h2>
    <h2 data-lang="kn" style="display:none;">ವೆಜಿಟೇಬಲ್ ಪುಲಾವ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Wash rice and soak 30 minutes.</li>
      <li>Heat ghee/oil, add cumin and sliced onion; sauté until golden.</li>
      <li>Add vegetables, turmeric, and salt; cook 5 minutes.</li>
      <li>Add rice and 2 cups water; cook until rice is done.</li>
      <li>Sprinkle garam masala and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಅಕ್ಕಿಯನ್ನು ತೊಳಸಿ 30 ನಿಮಿಷ ನೆನೆಸಿಡಿ.</li>
      <li>ಎಣ್ಣೆ/ಘೀ ಬಿಸಿಲು ಮಾಡಿ, ಜೀರಿಗೆ ಮತ್ತು ಈರುಳ್ಳಿ ಹಾಕಿ; ಬಂಗಾರದ ಬಣ್ಣ ಬರುವವರೆಗೆ ಬಾಡಿಸಿ.</li>
      <li>ತರಕಾರಿಗಳು, ಹಳದಿ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ; 5 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಅಕ್ಕಿ ಮತ್ತು 2 ಕಪ್ ನೀರು ಸೇರಿಸಿ; ಅಕ್ಕಿ ಚೆನ್ನಾಗಿ ಬೇಯಿಸಿರಿ.</li>
      <li>ಗರಂ ಮಸಾಲಾ ಚಿಮ್ಮಿ ಬಿಸಿಯಾಗಿ ಪೂರೈಕೆ ಮಾಡಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 119, name: "Vegetable Pulao", link: "veg/v7.php", image: "../food_image/recipes/vegetable_pulao.jpg" };

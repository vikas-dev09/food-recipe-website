...
<title>Idli with Coconut Chutney | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Idli with Coconut Chutney</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegs/veg11.webp" style="width:300px;height:300px;object-fit:cover;box-shadow:0 4px 8px rgba(0,0,0,1.3);">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>ಸೇವೆಗೆ ಕೋಸಂಬರಿ ಚಟ್ನಿ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Idli with Coconut Chutney</h2>
    <h2 data-lang="kn" style="display:none;">ಇಡ್ಲಿ ಕೋಸಂಬರಿ ಚಟ್ನಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Soak rice and urad dal for 4-6 hours.</li>
      <li>Grind to smooth batter and ferment overnight.</li>
    ...
    <ol data-lang="kn" style="display:none;">
      ...
      <li>ಮೃದುವಾದ ಬಟ್ಟೆ ಮಾಡಲು ಹುರಿದು, ರಾತ್ರಿಯವರೆಗೆ ಫರ್ಮೆಂಟ್ ಮಾಡಿ.</li>
      <li>ಬಟ್ಟೆ ಇಡ್ಲಿ ಸাঁচುಗಳಲ್ಲಿ ಹಾಕಿ 10-12 ನಿಮಿಷಗಳ ಕಾಲ ಸ್ಟೀಮ್ ಮಾಡಿ.</li>
      <li>ಬಿಸಿಯಾಗಿ ಕೋಸಂಬರಿ ಚಟ್ನಿಯೊಂದಿಗೆ ಸೇವಿಸಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 124, name: "Idli with Coconut Chutney", link: "veg/v12.php", image: "../food_image/recipes/idli_coconut.jpg" };

...
<div class="container">
  ...
  <h1>Aloo Gobi</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegs/veg4.jpg"  style="width:300px;height:300px;object-fit:cover;box-shadow:0 4px 8px rgba(0,0,0,1.3);">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>2 ಕಪ್ ಹೂಕೋಸು ಹೂವು</li>
      <li>2 ಮಧ್ಯಮ ಆಲೂಗಡ್ಡೆ, ಚದುರಿಸಿದ</li>
    ...
    <ol data-lang="en">
      ...
      <li>Add potatoes and cauliflower, turmeric, salt, and cook 10 min.</li>
      <li>Add tomato puree and garam masala, cook 5 more minutes.</li>
      <li>Garnish with coriander and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ ಜೀರಿಗೆ ಹಾಕಿ.</li>
      <li>ಈರುಳ್ಳಿ ಹಾಕಿ ಹುರಿಯಿರಿ.</li>
      <li>ಆಲೂಗಡ್ಡೆ ಮತ್ತು ಹೂಕೋಸು ಸೇರಿಸಿ ಹಳದಿ, ಉಪ್ಪು ಹಾಕಿ 10 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಟೊಮೆಟೋ ಪ್ಯೂರಿ ಮತ್ತು ಗರಂ ಮಸಾಲಾ ಸೇರಿಸಿ 5 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
...
const recipeData={id:116,name:"Aloo Gobi",link:"veg/v4.php",image:"../food_image/recipes/aloo_gobi.jpg"};

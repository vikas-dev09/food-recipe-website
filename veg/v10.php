...
<title>Dosa with Sambar | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Dosa with Sambar</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegs/veg10.jpeg" style="width:300px;height:300px;object-fit:cover;box-shadow:0 4px 8px rgba(0,0,0,1.3);">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>Sambar and coconut chutney for serving</li>
    </ul>
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಅಕ್ಕಿ</li>
      <li>1/4 ಕಪ್ ಉರದ ದಾಲ್</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ ತಕ್ಕಂತೆ</li>
      <li>ಬೇಯಿಸಲು ಎಣ್ಣೆ</li>
      <li>ಸೇವೆಗೆ ಸಂಪಾರ ಮತ್ತು ಕೋಸಂಬರಿ ಚಟ್ನಿ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Dosa with Sambar</h2>
    <h2 data-lang="kn" style="display:none;">ದೋಸಾ ಸಾಂಬಾರ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Soak rice and urad dal for 4-6 hours.</li>
      <li>Grind to a smooth batter and ferment overnight.</li>
      <li>Heat a non-stick pan, pour batter, and spread thin.</li>
      <li>Cook until golden and crisp, serve with sambar and chutney.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಅಕ್ಕಿ ಮತ್ತು ಉರದ ದಾಲ್ 4-6 ಗಂಟೆಗಳ ಕಾಲ ನೆನೆಸಿಡಿ.</li>
      <li>ತುಂಬಾ ಮೃದು ಬಟ್ಟೆ ಮಾಡುವವರೆಗೆ ಹುರಿದಳಿಸಿ, ರಾತ್ರಿಯವರೆಗೆ ಫರ್ಮೆಂಟ್ ಮಾಡಿ.</li>
      <li>ನಾನ್-ಸ್ಟಿಕ್ ಪ್ಯಾನ್ ಬಿಸಿಲು ಮಾಡಿ, ಬಟ್ಟೆ ಹಾಕಿ ಸಿಂಥವಾಗಿ ಹರಡಿ.</li>
      <li>ಸೋನಿಯಾಗಿ ಬಿಸಿ ಮತ್ತು ಕ್ರಿಸ್ ಆಗುವವರೆಗೆ ಬೇಯಿಸಿ, ಸಾಂಬಾರ್ ಮತ್ತು ಚಟ್ನಿಯೊಂದಿಗೆ ಸೇವಿಸಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 123, name: "Dosa with Sambar", link: "veg/v11.php", image: "../food_image/recipes/dosa_sambar.jpg" };

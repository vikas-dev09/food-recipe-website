...
<title>Bhindi Masala | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Bhindi Masala</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegs/veg8.jpg"  style="width:300px;height:300px;object-fit:cover;box-shadow:0 4px 8px rgba(0,0,0,1.3);">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      <li>250 g bhindi (okra), washed and cut</li>
    ...
    <ul data-lang="kn" style="display:none;">
      <li>250 ಗ್ರಾಂ ಭಿಂಡಿ, ತೊಳಸಿ ಕತ್ತರಿಸಿದ</li>
      ...
      <li>1/2 ಟೀಸ್ಪೂನ್ ಕೊತ್ತಂಬರಿ ಪುಡಿ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಎಣ್ಣೆ</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ ತಕ್ಕಂತೆ</li>
      <li>ತಾಜಾ ಕೊತ್ತಂಬರಿ ಅಲಂಕರಿಸಲು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Bhindi Masala</h2>
    <h2 data-lang="kn" style="display:none;">ಭಿಂಡಿ ಮಸಾಲಾ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat oil and add cumin seeds.</li>
      <li>Sauté onions until golden.</li>
      <li>Add tomatoes, green chilies, turmeric, and coriander powder; cook for 5 minutes.</li>
      <li>Add bhindi and salt; cook on low heat until tender.</li>
      <li>Garnish with fresh coriander and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಎಣ್ಣೆ ಬಿಸಿಲು ಮಾಡಿ ಜೀರೆ ಸೇರಿಸಿ.</li>
      <li>ಈರುಳ್ಳಿ ಬಂಗಾರದ ಬಣ್ಣ ಬರುವವರೆಗೆ ಬಾಡಿಸಿ.</li>
      <li>ಟೊಮೇಟೋ, ಹಸಿರು ಮೆಣಸು, ಹಳದಿ ಮತ್ತು ಕೊತ್ತಂಬರಿ ಪುಡಿ ಸೇರಿಸಿ; 5 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಭಿಂಡಿ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ; ನಿಧಾನ ಉರಿಯಲ್ಲಿ ಮೃದುಗೊಳ್ಳುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
      <li>ತಾಜಾ ಕೊತ್ತಂಬರಿಯಿಂದ ಅಲಂಕರಿಸಿ ಬಿಸಿಯಾಗಿ ಸೇವಿಸಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 121, name: "Bhindi Masala", link: "veg/v9.php", image: "../food_image/recipes/bhindi_masala.jpg" };

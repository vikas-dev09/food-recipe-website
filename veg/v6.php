...
<title>Palak Paneer | Foodies</title>
<style>
  /* CSS same as original page */
...
<div class="container">
  ...
  <h1>Palak Paneer</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegs/veg6.jpg"  style="width:300px;height:300px;object-fit:cover;box-shadow:0 4px 8px rgba(0,0,0,1.3);">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>200 ಗ್ರಾಂ ಪನೀರ್ ಕುಬ್ಸ್</li>
      <li>2 ಕಪ್ ಪಲಕ್ ಪ್ಯೂರಿ</li>
      <li>1 ಈರುಳ್ಳಿ, ಚೆನ್ನಾಗಿ ಕತ್ತರಿಸಿದ</li>
      <li>2 ಟೊಮೇಟೋ, ಪ್ಯೂರಿ ಮಾಡಿದ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಜೀರಿಗೆ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಶುಂಗಾದಿ-ಬೆಳ್ಳುಳ್ಳಿ ಪೇಸ್ಟ್</li>
    ...
    <h2 data-lang="en">Steps to Make Palak Paneer</h2>
    <h2 data-lang="kn" style="display:none;">ಪಲಕ್ ಪನೀರ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat oil/ghee and add cumin seeds.</li>
      <li>Add onion and sauté until golden.</li>
      <li>Add ginger-garlic paste and tomato puree; cook for 5 minutes.</li>
      <li>Add spinach puree, turmeric, garam masala, and salt; simmer 5-7 minutes.</li>
      <li>Add paneer cubes, cook 2-3 minutes, garnish with coriander, and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಎಣ್ಣೆ/ಘೀ ಬಿಸಿಲು ಮಾಡಿ, ಜೀರಿಗೆ ಸೇರಿಸಿ.</li>
      <li>ಈರುಳ್ಳಿ ಸೇರಿಸಿ ಬಂಗಾರದ ಬಣ್ಣ ಬರುವವರೆಗೆ ಬಾಡಿಸಿ.</li>
      <li>ಶುಂಗಾದಿ-ಬೆಳ್ಳುಳ್ಳಿ ಪೇಸ್ಟ್ ಮತ್ತು ಟೊಮೇಟೋ ಪ್ಯೂರಿ ಹಾಕಿ; 5 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಪಲಕ್ ಪ್ಯೂರಿ, ಹಳದಿ, ಗರಂ ಮಸಾಲಾ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ; 5-7 ನಿಮಿಷ ಕುದಿಸಿ.</li>
      <li>ಪನೀರ್ ಕುಬ್ಸ್ ಸೇರಿಸಿ 2-3 ನಿಮಿಷ ಬೇಯಿಸಿ, ಕೊತ್ತಂಬರಿ ಸೊಪ್ಪಿನಿಂದ ಅಲಂಕರಿಸಿ ಬಿಸಿಯಾದಾಗ ಸೇವಿಸಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 118, name: "Palak Paneer", link: "wik veg/v6.php", image: "../food_image/recipes/palak_paneer.jpg" };

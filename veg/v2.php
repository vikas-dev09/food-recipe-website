...
<title>Chole | Foodies</title>
<style>
/* Same CSS as previous template */
...
<div class="container">
  ...
  <h1>Chole</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegs/veg2.webp"  style="width:300px;height:300px;object-fit:cover;box-shadow:0 4px 8px rgba(0,0,0,1.3);">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಚಣಾ, ರಾತ್ರಿಯೂ ನೆನೆಸಿದ</li>
      <li>2 ಕಪ್ ನೀರು</li>
      ...
      <li>ಹಸಿರು ಕೊತ್ತಂಬರಿ</li>
    </ul>

    <h2 data-lang="en">Steps</h2>
    <h2 data-lang="kn" style="display:none;">ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Cook soaked chickpeas until tender.</li>
      <li>Heat oil, add cumin, onions and sauté.</li>
      <li>Add tomato puree and spices, cook 5 min.</li>
      <li>Add chickpeas, simmer 10 min.</li>
      <li>Garnish with coriander and serve.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಚಣಾಗಳು ಮೃದುವಾಗುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ ಜೀರಿಗೆ, ಈರುಳ್ಳಿ ಹಾಕಿ ಹುರಿಯಿರಿ.</li>
      <li>ಟೊಮೆಟೋ ಪ್ಯೂರಿ ಮತ್ತು ಮಸಾಲಾ ಸೇರಿಸಿ 5 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಚಣಾ ಸೇರಿಸಿ 10 ನಿಮಿಷ ಕುದಿಸಿ.</li>
...
const recipeData={id:114,name:"Chole",link:"veg/v2.php",image:"../food_image/recipes/chole.jpg"};

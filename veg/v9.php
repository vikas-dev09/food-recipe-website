...
<title>Baingan Bharta | Foodies</title>
<style>
...
<div class="container">
  ...
  <div class="food-img">
<img src="/food_recipe/food_image/vegs/veg9.jpg"  style="width:300px;height:300px;object-fit:cover;box-shadow:0 4px 8px rgba(0,0,0,1.3);">
  </div>
  ...
  <div id="recipe-content">
    ...
    <h2 data-lang="en">Steps to Make Baingan Bharta</h2>
    <h2 data-lang="kn" style="display:none;">ಬದನೆಕಾಯಿ ಭರ್ತಾ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Roast eggplant over flame until soft, peel and mash.</li>
      <li>Heat oil, add cumin, onion, and sauté till golden.</li>
      <li>Add tomatoes, green chilies, and cook 5 minutes.</li>
      <li>Add mashed eggplant and salt; cook 5-7 minutes.</li>
      <li>Garnish with coriander and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಬದನೆಕಾಯಿಯನ್ನು ಹಸಿವಿನ ಮೇಲೆ ಬೇಯಿಸಿ, ತುರಿದು ಹಾಕಿ.</li>
      <li>ಎಣ್ಣೆ ಬಿಸಿಲು ಮಾಡಿ, ಜೀರೆ, ಈರುಳ್ಳಿ ಸೇರಿಸಿ ಬಂಗಾರದ ಬಣ್ಣ ಬರುವವರೆಗೆ ಬಾಡಿಸಿ.</li>
      <li>ಟೊಮೇಟೋ, ಹಸಿರು ಮೆಣಸು ಸೇರಿಸಿ 5 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ತುರಿದ ಬದನೆಕಾಯಿ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ; 5-7 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
...
<script>
  ...
  const recipeData = { id: 120, name: "Baingan Bharta", link: " veg/v8.php", image: "../food_image/recipes/baingan_bharta.jpg" };

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name === '' || $email === '' || $subject === '' || $msg === '') {
        ...
        try {
            $stmt = $pdo->prepare("
                INSERT INTO contact (c_name, c_email, c_subject, c_msg)
           ...
           $_SESSION['success'] = 'Your message has been sent successfully. Our support team will review it and respond within 48 hours.';

        } catch (PDOException $e) {
            $_SESSION['error'] = 'Database Save Error: ' . $e->getMessage();
        }
    }
...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    /* Pulse animation reused from landing/categories */
    ...
    /* Not Found Modal (same as landing/categories) */
    .modal-overlay {
...
<body>
  ...
  <div class="main-content">
    <div class="contact-section">
      <h2>Contact Us</h2>
      <p>Have a question, suggestion, or recipe to share? We'd love to hear from you!</p>
      ...
      <form class="contact-form" method="post" action="contact.php">
        ...
        <input type="text" name="c_subject" placeholder="Subject" required>
        <textarea name="c_msg" rows="5" placeholder="Your Message" required></textarea>
  ...
  // Recipes map (same keys as other pages)
  const recipes = {

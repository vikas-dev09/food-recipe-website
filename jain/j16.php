...
<div class="container">
  ...
  <div class="food-img">
<img src="/food_recipe/food_image/jainn/ja16.jpeg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ja16">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ बाज್ರಾ ಹಿಟ್ಟು</li>
      <li>ಬೇಕಾದಷ್ಟು ಬಿಸಿ ನೀರು</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Jain Bajra Roti</h2>
    <h2 data-lang="kn" style="display:none;">ಜೈನ್ बाज್ರಾ ರೋಟಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Mix bajra flour and salt in a bowl.</li>
      <li>Add warm water gradually and knead into a soft dough.</li>
      <li>Divide the dough into small balls and roll each into a flat disc.</li>
      <li>Cook on a hot griddle until both sides are done, flipping as needed.</li>
      <li>Serve hot with sabzi or chutney.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಬಾಜ್ರಾ ಹಿಟ್ಟು ಮತ್ತು ಉಪ್ಪುವನ್ನು ಬೌಲ್‌ನಲ್ಲಿ ಮಿಶ್ರಣ ಮಾಡಿ.</li>
      <li>ಹಿತ್ತಳ ನೀರನ್ನು ಹಂತ ಹಂತವಾಗಿ ಸೇರಿಸಿ ಮೃದುವಾದ ಆಟಿಗೆ ಬಡಿ.</li>
      <li>ಆಟಿಯನ್ನು ಸಣ್ಣ ಚೆಂಡುಗಳಲ್ಲಿ ವಿಭಾಗಿಸಿ, ಪ್ರತಿ ಒಂದು ಫ್ಲಾಟ್ ಡಿಸ್ಕ್ ರೂಪಿಸಿ.</li>
      <li>ಬಿಸಿ ತವೆಯಲ್ಲಿ ಎರಡೂ ಬದಿಗಳನ್ನು ಬೇಯಿಸಿ, ಅಗತ್ಯವಿದ್ದರೆ ತಿರುಗಿಸಿ.</li>
      <li>ಬಿಸಿ ಬಿಸಿ ಸಬ್ಜಿ ಅಥವಾ ಚಟ್ನಿ ಜೊತೆ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
    ...
    <table data-lang="en">
      ...
      <tr><td>Calories</td><td>110 kcal</td></tr>
    ...
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಕ್ಯಾಲೊರಿ</td><td>110 kcal</td></tr>
...
<script>
  ...
  const recipeData = { id: 48, name: "Jain Bajra Roti", link: "jain/j16.php", image: "../food_image/roti/jain_bajra_roti.jpg" };

...
<title>Jain Navratan Korma | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Jain Navratan Korma</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/jainn/ja10.png" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ja10">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      <li>1 cup mixed vegetables (carrots, beans, peas, capsicum, cauliflower)</li>
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಮಿಶ್ರಿತ ತರಕಾರಿಗಳು (ಕಾರಟ್, ಬೀನ್ಸ್, ಬಟಾಣಿ, ಕ್ಯಾಪ್ಸಿಕಂ, ಹೂಕೋಸು)</li>
      <li>1/4 ಕಪ್ ಕಾಜು</li>
      <li>1/4 ಕಪ್ ತಾಜಾ ಕ್ರೀಮ್</li>
    ...
    <h2 data-lang="en">Steps to Make Jain Navratan Korma</h2>
    <h2 data-lang="kn" style="display:none;">ಜೈನ್ ನವರತ್ನ ಕೋರ್ಮಾ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat oil in a pan and add cumin seeds.</li>
      <li>Add ginger paste and sauté for 30 seconds.</li>
      <li>Add mixed vegetables and turmeric powder. Cook until tender.</li>
      <li>Add cashew nuts and cream, mix well, and simmer for 5 minutes.</li>
      <li>Adjust salt, garnish if desired, and serve hot with roti or rice.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಪ್ಯಾನ್‌ನಲ್ಲಿ ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ, ಜೀರಿಗೆ ಹಾಕಿ.</li>
      <li>ಶುಂಠಿ ಪೇಸ್ಟ್ ಸೇರಿಸಿ 30 ಸೆಕೆಂಡುಗಳಿಗಾಗಿ ತಾಳಿ.</li>
      <li>ಮಿಶ್ರಿತ ತರಕಾರಿಗಳು ಮತ್ತು ಹಳದಿ ಪುಡಿ ಸೇರಿಸಿ. ಸೊಪ್ಪಾಗುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
      <li>ಕಾಜು ಮತ್ತು ಕ್ರೀಮ್ ಸೇರಿಸಿ, ಚೆನ್ನಾಗಿ ಮಿಕ್ಸ್ ಮಾಡಿ, 5 ನಿಮಿಷ ಸಿಮ್ಮರ್ ಮಾಡಿ.</li>
      <li>ಉಪ್ಪು ತಕ್ಕಂತೆ ಸೇರಿಸಿ, ಇಚ್ಛೆಯಾದರೆ ಅಲಂಕರಿಸಿ, ರೋಟಿ ಅಥವಾ ಅನ್ನದೊಂದಿಗೆ ಬಿಸಿ ಬಿಸಿ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 42, name: "Jain Navratan Korma", link: "jain/j10.php", image: "../food_image/sabzi/jain_navratan_korma.jpg" };

...
<title>Jain Sev Tamatar | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Jain Sev Tamatar</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/jainn/ja14.jpeg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ja14">
s  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>2 tbsp butter</li>
      <li>Salt to taste</li>
      <li>Sev (fried gram flour noodles) for topping</li>
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>ಉಪ್ಪು ರುಚಿಗೆ</li>
      <li>ಮೇಲೆ ಹಾಕಲು ಸೇವು</li>
      <li>ಅಲಂಕಾರಕ್ಕೆ ಕೊತ್ತಂಬರಿ ಎಲೆಗಳು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Jain Sev Tamatar</h2>
    <h2 data-lang="kn" style="display:none;">ಜೈನ್ ಸೇವು ಟೊಮೇಟರ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat butter in a pan and add cumin seeds.</li>
      <li>Add ginger paste and sauté for a minute.</li>
      <li>Add tomato puree, turmeric, chili powder, and salt. Cook until thick.</li>
      <li>Pour the cooked tomato gravy into a serving bowl.</li>
      <li>Top with sev and garnish with coriander leaves.</li>
      <li>Serve immediately with poha or khichdi.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಪ್ಯಾನ್‌ನಲ್ಲಿ ಬೆಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ, ಜೀರಿಗೆ ಹಾಕಿ.</li>
      <li>ಶುಂಠಿ ಪೇಸ್ಟ್ ಸೇರಿಸಿ 1 ನಿಮಿಷ sauté ಮಾಡಿ.</li>
      <li>ಟೊಮೇಟೋ ಪ್ಯೂರಿ, ಹಳದಿ, ಮೆಣಸು ಪುಡಿ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ. ದಟ್ಟವಾಗುವವರೆಗೂ ಬೇಯಿಸಿ.</li>
      <li>ಬೇಯಿಸಿದ ಟೊಮೇಟೋ ಗ್ರೇವಿಯನ್ನು ಸೇವಿಂಗ್ ಬೌಲ್‌ನಲ್ಲಿ ಹಾಕಿ.</li>
      <li>ಮೇಲೆ ಸೇವು ಹಾಕಿ, ಕೊತ್ತಂಬರಿ ಎಲೆಗಳಿಂದ ಅಲಂಕಾರ ಮಾಡಿ.</li>
      <li>ತಕ್ಷಣ ಪೋಹಾ ಅಥವಾ ಖಿಚಡಿ ಜೊತೆಗೆ ಸೇವಿಸಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 46, name: "Jain Sev Tamatar", link: "jain/j14.php", image: "../food_image/paneer/jain_sev_tamatar.jpg" };

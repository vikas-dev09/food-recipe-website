...
<title>Jain Mixed Vegetable Curry | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Jain Mixed Vegetable Curry</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/jainn/ja9.jpg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ja9">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಕ್ಯಾರೆಟ್‌ಗಳು (ಚಿರುನಿಮಿಷ)</li>
      <li>1 ಕಪ್ ಬೀನ್ಸ್ (ಚಿರುನಿಮಿಷ)</li>
      <li>1 ಕಪ್ ಕ್ಯಾಪ್ಸಿಕಮ್ (ಚಿರುನಿಮಿಷ)</li>
      <li>1 ಕಪ್ ಹೂಲ್ ಹುರಿದ ಹೂಕುಸುಮಗಳು</li>
    ...
    <h2 data-lang="en">Steps to Make Jain Mixed Vegetable Curry</h2>
    <h2 data-lang="kn" style="display:none;">ಜೈನ್ ಮಿಶ್ರಿತ ತರಕಾರಿ ಕಾರಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat oil in a pan and sauté ginger paste and tomatoes.</li>
      <li>Add turmeric, chili powder, cumin powder, and salt.</li>
      <li>Add all vegetables and stir well.</li>
      <li>Cover and cook on low-medium heat for 10–12 minutes until vegetables are tender.</li>
    ...
    <ol data-lang="kn" style="display:none;">
      ...
      <li>ಹಳದಿ, ಮೆಣಸು ಪುಡಿ, ಜೀರಿಗೆ ಪುಡಿ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ.</li>
      <li>ಎಲ್ಲಾ ತರಕಾರಿಗಳನ್ನು ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಕಲಸಿ.</li>
      <li>ಕವರಿಂಗ್ ಮಾಡಿ ಮಧ್ಯಮ-ಕಡಿಮೆ ಉರಿಯಲ್ಲಿ 10–12 ನಿಮಿಷ ಬೇಯಿಸಿ, ತರಕಾರಿಗಳು ಸೊಪ್ಪಾಗುವವರೆಗೆ.</li>
...
<script>
  ...
  const recipeData = { id: 41, name: "Jain Mixed Vegetable Curry", link: "jain/j9.php", image: "../food_image/vegetables/jain_mixed_veg_curry.jpg" };

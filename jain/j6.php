...
<title>Jain Khichdi | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Jain Khichdi</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/jainn/ja6.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ja6">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      <li>1 cup rice</li>
      <li>1/2 cup split yellow moong dal (without skin)</li>
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಅಕ್ಕಿ</li>
      <li>1/2 ಕಪ್ ಹಸಿರು ಮೊಂಗ್ ದಾಲ್ (ಚರ್ಮವಿಲ್ಲದೆ)</li>
    ...
    <h2 data-lang="en">Steps to Make Jain Khichdi</h2>
    <h2 data-lang="kn" style="display:none;">ಜೈನ ಖಿಚ್ಡಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Wash rice and moong dal thoroughly.</li>
      <li>In a pressure cooker, heat ghee and add ginger paste and green chilies.</li>
      <li>Add rice, dal, turmeric, salt, and water. Mix well.</li>
      <li>Cook for 3-4 whistles or until soft.</li>
      <li>Garnish with fresh coriander leaves and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಅಕ್ಕಿ ಮತ್ತು ಮೊಂಗ್ ದಾಲ್ ಅನ್ನು ಚೆನ್ನಾಗಿ ತೊಳೆದುಕೊಳ್ಳಿ.</li>
      <li>ಪ್ರೆಶರ್ ಕುಕ್ಕರ್‌ನಲ್ಲಿ ತುಪ್ಪ ಬಿಸಿ ಮಾಡಿ, ಶುಂಠಿ ಪೇಸ್ಟ್ ಮತ್ತು ಹಸಿರು ಮೆಣಸಿನಕಾಯಿಗಳನ್ನು ಸೇರಿಸಿ.</li>
      <li>ಅಕ್ಕಿ, ದಾಲ್, ಹಳದಿ, ಉಪ್ಪು ಮತ್ತು ನೀರನ್ನು ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಕಲಸಿ.</li>
      <li>3-4 ಶ್ವೀಟಲ್‌ಗಳವರೆಗೆ ಅಥವಾ ನರಮವಾಗಿ ಆದವರೆಗೂ ಶ್ರಾವಣ ಮಾಡಿ.</li>
      <li>ಹಸಿರು ಕೊತ್ತಂಬರಿ ಎಲೆಗಳಿಂದ ಅಲಂಕರಿಸಿ ಬಿಸಿ ಬಿಸಿ ಸವಿಯಿರಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 38, name: "Jain Khichdi", link: "jain/j6.php", image: "../food_image/recipes/jain_khichdi.jpg" };

...
<title>Jain Aloo Capsicum Sabzi | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Jain Aloo Capsicum Sabzi</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/jainn/ja4.jpg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ja4">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>2 ಮಧ್ಯಮ ಆಲೂಗಡ್ಡೆ (ತೆಗೆಯಿರಿ ಮತ್ತು ಚೂರು ಮಾಡಿ)</li>
      <li>1 ದೊಡ್ಡ ಕ್ಯಾಪ್ಸಿಕಂ (ಚೂರು ಮಾಡಿ)</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಶುಂಠಿ ಪೇಸ್ಟ್</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಹಳದಿ ಪುಡಿ</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಜೀರಿಗೆ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಎಣ್ಣೆ</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ</li>
      <li>ಸಿದ್ಧಪಡಿಸಿದ ಕೊತ್ತಂಬರಿ ಎಲೆಗಳು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Jain Aloo Capsicum Sabzi</h2>
    <h2 data-lang="kn" style="display:none;">ಜೈನ್ ಆಲೂ ಕ್ಯಾಪ್ಸಿಕಂ ಸಬ್ಜಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat oil in a pan and add cumin seeds.</li>
      <li>Add ginger paste and sauté for 30 seconds.</li>
      <li>Add potatoes and turmeric powder, cook for 5-6 minutes.</li>
      <li>Add capsicum and salt, cook until vegetables are tender.</li>
    ...
    <ol data-lang="kn" style="display:none;">
      ...
      <li>ಆಲೂಗಡ್ಡೆ ಮತ್ತು ಹಳದಿ ಪುಡಿ ಸೇರಿಸಿ 5-6 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಕ್ಯಾಪ್ಸಿಕಂ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ ತರಕಾರಿಗಳು ಸೊಪ್ಪಾಗುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
      <li>ಕೊತ್ತಂಬರಿ ಎಲೆಗಳಿಂದ ಅಲಂಕರಿಸಿ, ರೋಟಿ ಅಥವಾ ಅನ್ನದೊಂದಿಗೆ ಬಿಸಿ ಬಿಸಿ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 36, name: "Jain Aloo Capsicum Sabzi", link: "jain/j5.php", image: "../food_image/sabzi/jain_aloo_capsicum.jpg" };

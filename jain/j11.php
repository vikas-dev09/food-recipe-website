...
<title>Jain Gatte ki Sabzi | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Jain Gatte ki Sabzi</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/jainn/ja11.avif" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ja11">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಬೇಳೆ ಹಿಟ್ಟು (ಬೆಸನ್)</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಹಳದಿ ಪುಡಿ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಕೆಂಪು ಮೆಣಸು ಪುಡಿ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಎಣ್ಣೆ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಜೀರಿಗೆ</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಸಾಸಿವೆ</li>
      <li>2 ಕಪ್ ಮೊಸರು</li>
      <li>1 ಕಪ್ ನೀರು</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ ತಕ್ಕಂತೆ</li>
      <li>ಗರ್ನಿಷ್ ಮಾಡಲು تازಾ ಕೊತ್ತಂಬರಿ ಸೊಪ್ಪು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Jain Gatte ki Sabzi</h2>
    <h2 data-lang="kn" style="display:none;">ಜೈನ್ ಗಟ್ಟೆ ಕಿ ಸಬ್ಜಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Mix besan, turmeric, and a pinch of salt with water to make dough. Roll and cut into small cylinders.</li>
      <li>Boil the gatte pieces in water for 10 minutes. Drain and set aside.</li>
      <li>Heat oil in a pan, add cumin and mustard seeds.</li>
      <li>Add yogurt, water, red chili powder, and salt. Bring to boil.</li>
      <li>Add boiled gatte pieces, simmer for 10 minutes.</li>
      <li>Garnish with coriander leaves and serve hot with roti or rice.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಬೆಸನ್, ಹಳದಿ ಮತ್ತು ಸ್ವಲ್ಪ ಉಪ್ಪು ನೀರಿನಲ್ಲಿ ಕಲಸಿ ಹಿಟ್ಟು ತಯಾರಿಸಿ. ಸಣ್ಣ ಚಿಲಂಡರ್ ಗಾಗಿ ಮಡಿಸಿ ಕತ್ತರಿಸಿ.</li>
      <li>ಗಟ್ಟೆ ತುಂಡುಗಳನ್ನು 10 ನಿಮಿಷ ನೀರಲ್ಲಿ ಬೇಯಿಸಿ. ನೀರು ಹೊರಹಾಕಿ ಬೇರೆ ಇಡಿ.</li>
      <li>ಒಂದು ಪ್ಯಾನ್‌ನಲ್ಲಿ ಎಣ್ಣೆ ಬಿಸಿಲು ಮಾಡಿ, ಜೀರಿಗೆ ಮತ್ತು ಸಾಸಿವೆ ಹಾಕಿ.</li>
      <li>ಮೊಸರು, ನೀರು, ಕೆಂಪು ಮೆಣಸು ಪುಡಿ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ ಕುದಿಸಿ.</li>
      <li>ಬೋಯಿಲ್ ಮಾಡಿದ ಗಟ್ಟೆ ತುಂಡುಗಳನ್ನು ಸೇರಿಸಿ 10 ನಿಮಿಷ ಸಿಮ್ಮರ್ ಮಾಡಿ.</li>
      <li>ಕೊತ್ತಂಬರಿ ಸೊಪ್ಪಿನಿಂದ ಅಲಂಕರಿಸಿ, ರೋಟಿ ಅಥವಾ ಅಕ್ಕಿಯೊಂದಿಗೆ ಬಿಸಿಯಾದಾಗ ಸೇವಿಸಿ.</li>
    </ol>

    <h2 data-lang="en">Nutrition Information (per serving)</h2>
    <h2 data-lang="kn" style="display:none;">ಪೌಷ್ಟಿಕ ಮಾಹಿತಿ (ಪ್ರತಿ serving)</h2>
    <table data-lang="en">
    ...
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಪ್ರೋಟೀನ್</td><td>8 g</td></tr>
...
<script>
  ...
  const recipeData = { id: 43, name: "Jain Gatte ki Sabzi", link: "jain/j11.php", image: "../food_image/recipes/jain_gatte_ki_sabzi.jpg" };

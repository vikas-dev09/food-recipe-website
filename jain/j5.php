...
<title>Jain Vegetable Biryani | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Jain Vegetable Biryani</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/jainn/ja5.jpeg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ja5">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>1 cup mixed vegetables (carrot, beans, peas, capsicum)</li>
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>1 ಕಪ್ ಮಿಶ್ರಿತ ತರಕಾರಿಗಳು (ಕಾರಟ್, ಬೀನ್ಸ್, ಪೀಸ್, ಕ್ಯಾಪ್ಸಿಕಮ್)</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಜೀರಿಗೆ</li>
      <li>1 ಇಂಚಿನ ಶುಂಗಾದಿ, ತುರಿದು</li>
      <li>2 ಹಸಿರು ಮೆಣಸು, ಚೂರಿ ಮಾಡಿದ</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಹಳದಿ ಪುಡಿ</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಗರಂ ಮಸಾಲಾ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಎಣ್ಣೆ ಅಥವಾ ಘೀ</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ ತಕ್ಕಂತೆ</li>
      <li>ಗರ್ನಿಷ್ ಮಾಡಲು تازಾ ಕೊತ್ತಂಬರಿ ಸೊಪ್ಪು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Jain Vegetable Biryani</h2>
    <h2 data-lang="kn" style="display:none;">ಜೈನ್ ವೆಜಿಟೇಬಲ್ ಬಿರಿಯಾನಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Wash rice and soak for 30 minutes.</li>
      <li>Heat oil/ghee in a pan, add cumin seeds, ginger, and green chilies.</li>
      <li>Add vegetables, turmeric, garam masala, and salt. Cook for 5-6 minutes.</li>
      <li>Add soaked rice and 2 cups water. Cook until rice is done.</li>
      <li>Garnish with coriander leaves and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಅಕ್ಕಿಯನ್ನು ತೊಳಸಿ 30 ನಿಮಿಷ ನೆನೆಸಿಡಿ.</li>
      <li>ಒಂದು ಪ್ಯಾನ್‌ನಲ್ಲಿ ಎಣ್ಣೆ/ಘೀ ಬಿಸಿಲು ಮಾಡಿ, ಜೀರಿಗೆ, ಶುಂಗಾದಿ ಮತ್ತು ಹಸಿರು ಮೆಣಸನ್ನು ಹಾಕಿ.</li>
      <li>ತರಕಾರಿಗಳನ್ನು, ಹಳದಿ, ಗರಂ ಮಸಾಲಾ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ 5-6 ನಿಮಿಷಗಳ ಕಾಲ ಬೇಯಿಸಿ.</li>
      <li>ನೆನೆಸಿದ ಅಕ್ಕಿ ಮತ್ತು 2 ಕಪ್ ನೀರು ಸೇರಿಸಿ ಅಕ್ಕಿ ಚೆನ್ನಾಗಿ ಬೇಯಿಸಿ.</li>
      <li>ಕೊತ್ತಂಬರಿ ಸೊಪ್ಪಿನಿಂದ ಅಲಂಕರಿಸಿ ಬಿಸಿಯಾದಾಗ ಸೇವಿಸಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 37, name: "Jain Vegetable Biryani", link: "jain/j5.php", image: "../food_image/recipes/jain_veg_biryani.jpg" };

...
<title>Jain Sabudana Khichdi | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Jain Sabudana Khichdi</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/jainn/ja12.jpeg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ja12">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>2-3 green chilies (optional)</li>
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಸಬೂದಾನ (ಚೆರಿಗೆ ಪೆರ್ಸಲ್ಸ್)</li>
      <li>1/2 ಕಪ್ ಹುರಿದ ಮೆಣಸು (ಥಟ್ಟಿದ)</li>
      <li>2-3 ಹಸಿರು ಮೆಣಸಿನಕಾಯಿ (ಐಚ್ಛಿಕ)</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಶುಂಠಿ ಪೇಸ್ಟ್</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ತುಪ್ಪ ಅಥವಾ ಎಣ್ಣೆ</li>
      <li>ರುಚಿಗೆ ತಕ್ಕ ಉಪ್ಪು ಮತ್ತು ಸಕ್ಕರೆ</li>
      <li>1 ಕಪ್ ನೀರು</li>
      <li>ಹಸಿರು ಕೊತ್ತಂಬರಿ ಎಲೆಗಳು ಅಲಂಕರಿಸಲು</li>
      <li>1 ಟೀಸ್ಪೂನ್ ನಿಂಬೆ ರಸ (ಐಚ್ಛಿಕ)</li>
    </ul>

    <h2 data-lang="en">Steps to Make Jain Sabudana Khichdi</h2>
    <h2 data-lang="kn" style="display:none;">ಜೈನ ಸಬೂದಾನ ಖಿಚ್ಡಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Rinse sabudana well and soak in water for 4-5 hours.</li>
      <li>Heat ghee/oil in a pan, add ginger paste and green chilies.</li>
      <li>Add soaked sabudana, peanuts, salt, sugar, and mix gently.</li>
      <li>Cook on low flame until pearls become translucent.</li>
      <li>Garnish with coriander leaves and lemon juice. Serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಸಬೂದಾನವನ್ನು ಚೆನ್ನಾಗಿ ತೊಳೆದು 4-5 ಗಂಟೆಗಳ ಕಾಲ ನೀರಿನಲ್ಲಿ ನೆನೆಸಿಡಿ.</li>
      <li>ಪ್ಯಾನ್‌ನಲ್ಲಿ ತುಪ್ಪ/ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ, ಶುಂಠಿ ಪೇಸ್ಟ್ ಮತ್ತು ಹಸಿರು ಮೆಣಸಿನಕಾಯಿಗಳನ್ನು ಸೇರಿಸಿ.</li>
      <li>ನೆನೆಸಿದ ಸಬೂದಾನ, ಮೆಣಸು, ಉಪ್ಪು, ಸಕ್ಕರೆ ಸೇರಿಸಿ ಸೌಮ್ಯವಾಗಿ ಕಲಸಿ.</li>
      <li>ಮೆಣಸುಗಳು ಪಾರದರ್ಶಕವಾಗುವವರೆಗೆ ಕಡಿಮೆ ಹಿಟ್ಟಿನಲ್ಲಿ ಶ್ರಾವಣ ಮಾಡಿ.</li>
      <li>ಕೊತ್ತಂಬರಿ ಎಲೆಗಳು ಮತ್ತು ನಿಂಬೆ ರಸದಿಂದ ಅಲಂಕರಿಸಿ ಬಿಸಿ ಬಿಸಿ ಸವಿಯಿರಿ.</li>
    </ol>
    ...
    <table data-lang="en">
      ...
      <tr><td>Carbohydrates</td><td>55 g</td></tr>
    ...
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಕಾರ್ಬೊಹೈಡ್ರೇಟ್ಸ್</td><td>55 g</td></tr>
...
<script>
  ...
  const recipeData = { id: 44, name: "Jain Sabudana Khichdi", link: "jain/j12.php", image: "../food_image/recipes/jain_sabudana_khichdi.jpg" };

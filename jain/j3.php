...
<title>Jain Matar Paneer | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Jain Matar Paneer</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/jainn/ja3.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ja3">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>200 ಗ್ರಾಂ ಪನೀರ್ (ಕ್ಯೂಬ್‌ಗಳಲ್ಲಿ)</li>
      <li>1 ಕಪ್ ಹಸಿಮೆಣಸು</li>
    ...
    <h2 data-lang="en">Steps to Make Jain Matar Paneer</h2>
    <h2 data-lang="kn" style="display:none;">ಜೈನ್ ಮಟರ್ ಪನೀರ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat oil in a pan and sauté onions until golden.</li>
      <li>Add ginger paste and sauté for 1 minute.</li>
      <li>Add tomatoes, turmeric, chili powder, and salt. Cook until tomatoes soften.</li>
      <li>Add green peas and cook for 3–4 minutes.</li>
      <li>Add paneer cubes and garam masala. Mix gently.</li>
      <li>Cook for another 2–3 minutes, garnish with coriander leaves.</li>
      <li>Serve hot with roti or rice.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಪ್ಯಾನ್‌ನಲ್ಲಿ ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ ಈರುಳ್ಳಿ ಬಂಗಾರದ ಬಣ್ಣದಾಗುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
      <li>ಶುಂಠಿ ಪೇಸ್ಟ್ ಸೇರಿಸಿ 1 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಟೊಮೇಟೋ, ಹಳದಿ, ಮೆಣಸು ಪುಡಿ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ ಟೊಮೇಟೋ ಮೃದುವಾಗುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
      <li>ಹಸಿಮೆಣಸು ಸೇರಿಸಿ 3–4 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಪನೀರ್ ಕ್ಯೂಬ್‌ಗಳನ್ನು ಮತ್ತು ಗರಂ ಮಸಾಲಾ ಸೇರಿಸಿ. ಎಳೆದು ಕಲಸಿ.</li>
      <li>ಮತ್ತೆ 2–3 ನಿಮಿಷ ಬೇಯಿಸಿ, ಕೊತ್ತಂಬರಿ ಎಲೆಗಳಿಂದ ಅಲಂಕರಿಸಿ.</li>
      <li>ತಂಡಿ ಅಥವಾ ಭಾತ್ ಜೊತೆ ಬಿಸಿ ಬಿಸಿ ಸವಿಯಿರಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 35, name: "Jain Matar Paneer", link: "jain/j3.php", image: "../food_image/paneer/jain_matar_paneer.jpg" };

...
<title>Jain Paneer Butter Masala | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Jain Paneer Butter Masala</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/jainn/ja2.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ja2">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      <li>200g paneer (Jain style, without onion & garlic)</li>
    ...
    <ul data-lang="kn" style="display:none;">
      <li>200 ಗ್ರಾಂ ಪನೀರ್ (ಜೈನ್ ಶೈಲಿ, ಈರುಳ್ಳಿ ಮತ್ತು ಬೆಳ್ಳುಳ್ಳಿ ಇಲ್ಲದೆ)</li>
      <li>2 ಮಧ್ಯಮ ಟೊಮೇಟೋ, ಪ್ಯೂರಿ ಮಾಡಿದ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಬೆಣ್ಣೆ</li>
      <li>1/4 ಕಪ್ ಫ್ರೆಶ್ ಕ್ರೀಮ್</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಶುಂಠಿ ಪೇಸ್ಟ್</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಹಳದಿ ಪುಡಿ</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಮೆಣಸು ಪುಡಿ</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಗರಂ ಮಸಾಲಾ</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ</li>
      <li>ಸೋಮಿನ ಕೊತ್ತಂಬರಿ ಎಲೆಗಳು (ಅಲಂಕಾರಕ್ಕಾಗಿ)</li>
    </ul>

    <h2 data-lang="en">Steps to Make Jain Paneer Butter Masala</h2>
    <h2 data-lang="kn" style="display:none;">ಜೈನ್ ಪನೀರ್ ಬಟರ್ ಮಸಾಲಾ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      ...
      <li>Stir in cream and garam masala. Cook for 2 more minutes.</li>
    ...
    <ol data-lang="kn" style="display:none;">
      ...
      <li>ಪನೀರ್ ಕ್ಯೂಬ್‌ಗಳು ಸೇರಿಸಿ 5 ನಿಮಿಷಗಳಿಡಿ simmer ಮಾಡಿ.</li>
      <li>ಕ್ರೀಮ್ ಮತ್ತು ಗರಂ ಮಸಾಲಾ ಸೇರಿಸಿ 2 ನಿಮಿಷ ಹೆಚ್ಚು ಬೇಯಿಸಿ.</li>
      <li>ಕೊತ್ತಂಬರಿ ಎಲೆಗಳಿಂದ ಅಲಂಕಾರ ಮಾಡಿ, ರೋಟಿ ಅಥವಾ ಅನ್ನದೊಂದಿಗೆ ಬಿಸಿ ಬಿಸಿ ಸೇವಿಸಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 34, name: "Jain Paneer Butter Masala", link: "jain/j2.php", image: "../food_image/paneer/jain_paneer_butter_masala.jpg" };

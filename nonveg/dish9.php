...
<div class="container">
  ...
  <h1>Prawn Curry</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/nonveg/non9.jpeg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="non9">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>500 ಗ್ರಾಂ ಚೇನು (ಸ್ವಚ್ಛಗೊಳಿಸಿದ)</li>
      ...
      <li>200 ಮಿ.ಲೀ. ತೆಂಗಿನ ಹಾಲು</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Prawn Curry</h2>
    <h2 data-lang="kn" style="display:none;">ಚೇನು ಕರಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat oil in a pan, sauté onions until golden.</li>
      <li>Add ginger-garlic paste, tomatoes, and spices. Cook until oil separates.</li>
      <li>Add prawns and cook for 3–4 minutes.</li>
      <li>Pour coconut milk, simmer for 5 minutes.</li>
      <li>Garnish with coriander and serve hot with rice.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ ಈರುಳ್ಳಿ ಬಂಗಾರದ ಬಣ್ಣ ಬರುವವರೆಗೆ ಹುರಿಯಿರಿ.</li>
      <li>ಶುಂಠಿ-ಬೆಳ್ಳುಳ್ಳಿ ಪೇಸ್ಟ್, ಟೊಮಾಟೊ ಮತ್ತು ಮಸಾಲೆ ಹಾಕಿ ಹುರಿಯಿರಿ.</li>
      <li>ಚೇನು ಹಾಕಿ 3–4 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ತೆಂಗಿನ ಹಾಲು ಸೇರಿಸಿ 5 ನಿಮಿಷ ಸಣ್ಣ ಉರಿಯಲ್ಲಿ ಬೇಯಿಸಿ.</li>
      <li>ಧನಿಯಾ ಹಾಕಿ ಅನ್ನದ ಜೊತೆ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 57, name: "Prawn Curry", link: "nonveg/dish9.php", image: "../food_image/prawns/prawn_curry.jpg" };

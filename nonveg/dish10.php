...
<div class="container">
  ...
  <h1>Fish Fry</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/nonveg/non10.jpg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="non10">
  </div>
  ...
  <div id="recipe-content">
    ...
    <h2 data-lang="en">Steps to Make Fish Fry</h2>
    <h2 data-lang="kn" style="display:none;">ಮೀನು ಫ್ರೈ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Mix chili powder, turmeric, lemon juice, and salt to form a paste.</li>
      <li>Coat fish fillets evenly and marinate for 20 minutes.</li>
      <li>Dust lightly with rice flour.</li>
      <li>Heat oil in a pan and fry each side until golden and crisp.</li>
      <li>Serve hot with onions and lemon wedges.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಮೆಣಸು ಪುಡಿ, ಹಳದಿ, ನಿಂಬೆ ರಸ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ ಪೇಸ್ಟ್ ಮಾಡಿ.</li>
      <li>ಮೀನು ತುಂಡುಗಳಿಗೆ ಹಚ್ಚಿ 20 ನಿಮಿಷ ಮೆರಿನೇಟ್ ಮಾಡಿ.</li>
      <li>ಅಕ್ಕಿ ಹಿಟ್ಟು ಸ್ವಲ್ಪ ಸಿಂಪಿಸಿ.</li>
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ ಪ್ರತಿ ಬದಿಯನ್ನು ಬಂಗಾರದ ಬಣ್ಣ ಬರುವವರೆಗೆ ಫ್ರೈ ಮಾಡಿ.</li>
      <li>ಈರುಳ್ಳಿ ಮತ್ತು ನಿಂಬೆ ತುಂಡುಗಳೊಂದಿಗೆ ಬಿಸಿ ಬಿಸಿ ಸೇವಿಸಿ.</li>
    </ol>
    ...
    <table data-lang="en">
      ...
      <tr><td>Protein</td><td>26 g</td></tr>
    ...
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಪ್ರೋಟೀನ್</td><td>26 g</td></tr>
...
<script>
  ...
  const recipeData = { id: 58, name: "Fish Fry", link: "nonveg/dish10.php", image: "../food_image/fish/fish_fry.jpg" };

...
<title>Mutton Korma | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Mutton Korma</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/nonveg/non15.jpg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="non15">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>500 ಗ್ರಾಂ ಮಟನ್, ಸ್ವಚ್ಛಗೊಳಿಸಿದ</li>
      <li>2 ಈರುಳ್ಳಿ, ಸ್ಲೈಸ್ ಮಾಡಿದ</li>
      <li>2 ಟೊಮೇಟೊ, ಕತ್ತರಿಸಿದ</li>
      <li>1/2 ಕಪ್ ಮೊಸರು</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಶುಂಠಿ ಬೆಳ್ಳುಳ್ಳಿ ಪೇಸ್ಟ್</li>
      <li>2 ಟೀಸ್ಪೂನ್ ಧನಿಯಾ ಪುಡಿ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಮೆಣಸು ಪುಡಿ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಗರಂ ಮಸಾಲಾ</li>
      <li>ಉಪ್ಪು ಮತ್ತು ಎಣ್ಣೆ ಅಗತ್ಯವಿದ್ದಷ್ಟು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Mutton Korma</h2>
    <h2 data-lang="kn" style="display:none;">ಮಟನ್ ಕೋರ್ಮ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat oil and sauté onions till golden.</li>
      <li>Add ginger-garlic paste and cook for 1 min.</li>
      <li>Add tomatoes and spices, cook till soft.</li>
      <li>Add mutton pieces and fry for 5–7 minutes.</li>
      <li>Add curd, mix well, and cook till mutton is tender.</li>
    ...
    <ol data-lang="kn" style="display:none;">
      ...
      <li>ಟೊಮೇಟೊ ಮತ್ತು ಮಸಾಲೆಗಳು ಸೇರಿಸಿ ಮೃದುವಾಗುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
      <li>ಮಟನ್ ತುಂಡುಗಳನ್ನು ಸೇರಿಸಿ 5–7 ನಿಮಿಷ ಹುರಿಯಿರಿ.</li>
      <li>ಮೊಸರು ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಕಲಸಿ ಮಟನ್ ಮೃದುವಾಗುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
...
<script>
  ...
  const recipeData = { id: 63, name: "Mutton Korma", link: "nonveg/dish15.php", image: "../food_image/mutton/mutton_korma.jpg" };

...
<title>Chicken Tandoori | Foodies</title>
<style>
  /* Same CSS as before */
...
<div class="container">
  ...
  <div class="food-img">
<img src="/food_recipe/food_image/nonveg/non4.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="non4">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>500 ಗ್ರಾಂ ಚಿಕನ್ ಡ್ರಮ್ಸ್ಟಿಕ್ಸ್</li>
      <li>1/2 ಕಪ್ ಮೊಸರು</li>
      ...
      <li>1 ಟೇಬಲ್‌ಸ್ಪೂನ್ ನಿಂಬೇ ಹಣ್ಣು ರಸ</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಎಣ್ಣೆ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Chicken Tandoori</h2>
    <h2 data-lang="kn" style="display:none;">ಚಿಕನ್ ತಂದೂರಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Mix all ingredients except chicken to make a marinade.</li>
      <li>Coat chicken with marinade and refrigerate for 2-3 hours.</li>
      <li>Preheat oven to 200°C. Bake chicken for 25-30 mins until cooked.</li>
      <li>Serve hot with mint chutney or salad.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಚಿಕನ್ ಹೊರತುಪಡಿಸಿ ಎಲ್ಲಾ ಸಾಮಗ್ರಿಗಳನ್ನು ಮಿಕ್ಸ್ ಮಾಡಿ ಮೆರಿನೇಡ್ ತಯಾರಿಸಿ.</li>
      <li>ಚಿಕನ್ ಅನ್ನು ಮೆರಿನೇಡ್‌ನಲ್ಲಿ ಲೇಪಿಸಿ 2-3 ಗಂಟೆ ಫ್ರಿಜ್‌ನಲ್ಲಿ ಇರಿಸಿ.</li>
      <li>ಒವೆನ್ 200°C ಗೆ ಪೂರ್ವಬಿಸಿ ಮಾಡಿ. 25-30 ನಿಮಿಷ ಚಿಕನ್ ಬೇಯಿಸಿ.</li>
      <li>ಹಸಿರು ಚಟ್ನಿ ಅಥವಾ ಸಲಾಡ್ ಜೊತೆ ಬಿಸಿ ಬಿಸಿ ಸೇವಿಸಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 52, name: "Chicken Tandoori", link: "nonveg/dish4.php", image: "../food_image/chicken/chicken_tandoori.jpg" };

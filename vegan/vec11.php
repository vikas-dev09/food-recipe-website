...
<title>Vegan Samosa | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Vegan Samosa</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegan/vag11.jpg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ve3">  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>1/2 ಕಪ್ ನೀರು</li>
      <li>2 ಆಲೂಗಡ್ಡೆ, ಬೇಯಿಸಿ ತುರಿದು</li>
      <li>1/2 ಕಪ್ ಪೀಸ್</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಜೀರೆ</li>
      <li>ಉಪ್ಪು ಮತ್ತು ಮಸಾಲೆಗಳು ರುಚಿಗೆ ತಕ್ಕಂತೆ</li>
      <li>ತಲೆಗೆ ಎಣ್ಣೆ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Vegan Samosa</h2>
    <h2 data-lang="kn" style="display:none;">ವೀಗನ್ ಸಮೋಸಾ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Prepare dough with flour and water.</li>
      <li>Make filling with potatoes, peas, spices.</li>
      <li>Shape samosas and fill with mixture.</li>
      <li>Deep fry until golden brown.</li>
      <li>Serve hot with chutney.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಹಿಟ್ಟು ಮತ್ತು ನೀರಿನಿಂದ ಹಿಟ್ಟು ತಯಾರಿಸಿ.</li>
      <li>ಆಲೂಗಡ್ಡೆ, ಪೀಸ್ ಮತ್ತು ಮಸಾಲೆಯಿಂದ ತುಂಬಣೆ ತಯಾರಿಸಿ.</li>
      <li>ಸಮೋಸಾ ರೂಪಿಸಿ ತುಂಬಣೆ ತುಂಬಿ.</li>
      <li>ಬಂಗಾರದ ಬಣ್ಣ ಬರುವವರೆಗೆ ತಲೆಗೆ ಹುರಿದುಕೊಳ್ಳಿ.</li>
      <li>ಬಿಸಿಯಾಗಿ ಚಟ್ನಿಯೊಂದಿಗೆ ಸೇವಿಸಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 139, name: "Vegan Samosa", link: "vegan/vec11.php", image: "../food_image/recipes/vegan_samosa.jpg" };

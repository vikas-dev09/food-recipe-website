...
<title>Gatte Ki Sabzi | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Gatte Ki Sabzi</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegan/vag4.jpg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ve4">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ol data-lang="en">
      <li>Make besan dough, roll into cylinders, boil and cut into pieces.</li>
      <li>Heat oil, add cumin seeds and sauté onions.</li>
      <li>Add tomato puree, turmeric, chili powder, coriander powder, salt; cook 5–7 min.</li>
      <li>Add gatte pieces and simmer 10 min.</li>
      <li>Garnish with coriander and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಬೇಸನ್ ಮಿಶ್ರಣ ಮಾಡಿ ಗಟ್ಟೆಗಳಾಗಿ ತಯಾರಿಸಿ, ಬೇಯಿಸಿ, ತುಂಡುಮಾಡಿ.</li>
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ ಜೀರೆ ಹಾಕಿ ಈರುಳ್ಳಿಯನ್ನು ಹುರಿ.</li>
      <li>ಟೊಮೆಟೋ ಪ್ಯೂರಿ, ಹಳದಿ, ಮೆಣಸು ಪುಡಿ, ಧನಿಯಾ ಪುಡಿ, ಉಪ್ಪು ಸೇರಿಸಿ 5–7 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಗಟ್ಟೆ ತುಂಡುಗಳನ್ನು ಸೇರಿಸಿ 10 ನಿಮಿಷ ಕುಡಿಸಿ.</li>
...
const recipeData={id:132,name:"Gatte Ki Sabzi",link:"vegan/ve4.php",image:"../food_image/recipes/gatte_ki_sabzi.jpg"};

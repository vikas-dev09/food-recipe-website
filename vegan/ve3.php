...
<title>Toor Dal Fry | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Toor Dal Fry</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegan/vag3.jpg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ve3">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      <li>1 cup toor dal (split pigeon peas), washed and soaked</li>
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ತೂರು ಡಾಲ್, ತೊಳಸಿ ನೆನೆಸಿಡಿ</li>
      <li>1 ಈರುಳ್ಳಿ, ಚಿರಿತ</li>
      <li>2 ಟೊಮೆಟೋ, ಪ್ಯೂರಿ ಮಾಡಿದ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಜೀರೆ</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಹಳದಿ ಪುಡಿ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಮೆಣಸು ಪುಡಿ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಎಣ್ಣೆ/ಘೀ</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ ತಕ್ಕಂತೆ</li>
      <li>ತಾಜಾ ಕೊತ್ತಂಬರಿ ಸೊಪ್ಪು</li>
    </ul>

    <h2 data-lang="en">Steps</h2>
    <h2 data-lang="kn" style="display:none;">ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Cook soaked toor dal until soft.</li>
      <li>Heat ghee/oil, add cumin seeds and sauté onions.</li>
      <li>Add tomato puree, turmeric, red chili powder, salt; cook 5–7 min.</li>
      <li>Add cooked dal and simmer for 10 min.</li>
      <li>Garnish with coriander and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ನೆನೆಸಿದ ತೂರು ಡಾಲ್ ಅನ್ನು ಚೆನ್ನಾಗಿ ಬೇಯಿಸಿ.</li>
      <li>ಎಣ್ಣೆ/ಘೀ ಬಿಸಿ ಮಾಡಿ ಜೀರೆ ಹಾಕಿ ಈರುಳ್ಳಿಯನ್ನು ಹುರಿ.</li>
      <li>ಟೊಮೆಟೋ ಪ್ಯೂರಿ, ಹಳದಿ, ಮೆಣಸು ಪುಡಿ, ಉಪ್ಪು ಸೇರಿಸಿ 5–7 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಬೇಯಿಸಿದ ಡಾಲ್ ಸೇರಿಸಿ 10 ನಿಮಿಷ ಕುಡಿಸಿ.</li>
      <li>ಕೊತ್ತಂಬರಿ ಹಾಕಿ ಬಿಸಿಯಾದಾಗ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
    ...
    <table data-lang="en">
      ...
      <tr><td>Carbs</td><td>38 g</td></tr>
      <tr><td>Protein</td><td>11 g</td></tr>
      <tr><td>Fat</td><td>6 g</td></tr>
      <tr><td>Fiber</td><td>7 g</td></tr>
    </table>
    <table data-lang="kn" style="display:none;">
      <tr><th>ಪೋಷಕಾಂಶ</th><th>ಪ್ರಮಾಣ</th></tr>
      <tr><td>ಕ್ಯಾಲೊರಿ</td><td>230 kcal</td></tr>
      <tr><td>ಕಾರ್ಬೊಹೈಡ್ರೇಟ್ಸ್</td><td>38 g</td></tr>
      <tr><td>ಪ್ರೋಟೀನ್</td><td>11 g</td></tr>
      <tr><td>ಕೊಬ್ಬು</td><td>6 g</td></tr>
      <tr><td>ಫೈಬರ್</td><td>7 g</td></tr>
    </table>
...
const recipeData={id:131,name:"Toor Dal Fry",link:"vegan/ve3.php",image:"../food_image/recipes/toor_dal_fry.jpg"};

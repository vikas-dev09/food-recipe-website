...
<title>Tinda Masala | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Tinda Masala</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegan/vag15.jpg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ve3">  </div>

  <div id="recipe-content">
    <h2 data-lang="en">Ingredients</h2>
    <h2 data-lang="kn" style="display:none;">ಸಾಮಗ್ರಿಗಳು</h2>
    <ul data-lang="en">
      <li>500 g Tinda (Indian round gourd), chopped</li>
    ...
    <ul data-lang="kn" style="display:none;">
      <li>500 ಗ್ರಾಂ ಟಿಂಡಾ, ಚೂರು ಮಾಡಿದ</li>
      <li>1 ಈರುಳ್ಳಿ, ಕತ್ತರಿಸಿದ</li>
      <li>2 ಟೊಮೇಟೋ, ಕತ್ತರಿಸಿದ</li>
      <li>2 ಹಸಿರು ಮೆಣಸು, ಕತ್ತರಿಸಿದ</li>
      ...
      <li>ತಾಜಾ ಕೊತ್ತಂಬರಿ ಅಲಂಕರಿಸಲು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Tinda Masala</h2>
    <h2 data-lang="kn" style="display:none;">ಟಿಂಡಾ ಮಸಾಲಾ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat oil in a pan and add cumin seeds.</li>
      <li>Add onions and green chilies; sauté till golden brown.</li>
      <li>Add tomatoes, turmeric, garam masala, and salt; cook until tomatoes are soft.</li>
      <li>Add chopped Tinda, cover, and cook until tender.</li>
      <li>Garnish with coriander and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಪ್ಯಾನ್‌ನಲ್ಲಿ ಎಣ್ಣೆ ಬಿಸಿಲು ಮಾಡಿ ಜೀರೆ ಹಾಕಿ.</li>
      <li>ಈರುಳ್ಳಿ ಮತ್ತು ಹಸಿರು ಮೆಣಸು ಸೇರಿಸಿ; ಬಂಗಾರದ ಬಣ್ಣ ಬರುವವರೆಗೆ ಬಾಡಿಸಿ.</li>
      <li>ಟೊಮೇಟೋ, ಹಳದಿ, ಗರಂ ಮಸಾಲಾ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ; ಟೊಮೇಟೋ ಮೃದುವಾಗುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
      <li>ಚೂರು ಮಾಡಿದ ಟಿಂಡಾ ಸೇರಿಸಿ, ಮುಚ್ಚಿ ನರ್ಮವಾಗುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
      <li>ಕೊತ್ತಂಬರಿ ಹಾಕಿ ಬಿಸಿಯಾಗಿ ಸೇವಿಸಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 143, name: "Tinda Masala", link: "vegan/ve15.php", image: "../food_image/recipes/tinda_masala.jpg" };

...
<div class="container">
  ...
  <h1>Poha</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegan/vag13.webp"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ve3">  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>2 tbsp oil</li>
      <li>Salt to taste</li>
      <li>Fresh coriander and lemon for garnish</li>
    </ul>
    <ul data-lang="kn" style="display:none;">
      <li>2 ಕಪ್ ಫ್ಲಾಟ್ ಮಾಡಿರುವ ಅಕ್ಕಿ (ಪೋಹ)</li>
      <li>1 ಈರುಳ್ಳಿ, ಚೆನ್ನಾಗಿ ಕತ್ತರಿಸಿದ</li>
      <li>1 ಹಸಿರು ಮೆಣಸು, ಕತ್ತರಿಸಿದ</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಆದು ಬೀಜ</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಹಳದಿ ಪುಡಿ</li>
      <li>10 ಕರಿಯ ಪುಡಿಗಳು</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಎಣ್ಣೆ</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ ತಕ್ಕಂತೆ</li>
      <li>ತಾಜಾ ಕೊತ್ತಂಬರಿ ಮತ್ತು ನಿಂಬೆ ಅಲಂಕರಿಸಲು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Poha</h2>
    <h2 data-lang="kn" style="display:none;">ಪೋಹ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Rinse poha in water and drain.</li>
      <li>Heat oil, add mustard seeds, curry leaves, onions, and green chili. Sauté till onion is soft.</li>
      <li>Add turmeric, salt, and poha. Mix gently and cook 2–3 minutes.</li>
      <li>Garnish with coriander leaves and lemon juice before serving.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಪೋಹವನ್ನು ನೀರಿನಲ್ಲಿ ತೊಳಸಿ, ನೀರನ್ನು ನಿಟ್ಟು ಹಾಕಿ.</li>
      <li>ಎಣ್ಣೆ ಬಿಸಿಲು ಮಾಡಿ, ಆದು ಬೀಜ, ಕರಿಯ ಪುಡಿಗಳು, ಈರುಳ್ಳಿ ಮತ್ತು ಹಸಿರು ಮೆಣಸು ಹಾಕಿ. ಈರುಳ್ಳಿ ತಂಪಾದಾಗ ಬಾಡಿಸಿ.</li>
      <li>ಹಳದಿ, ಉಪ್ಪು ಮತ್ತು ಪೋಹ ಸೇರಿಸಿ. 2–3 ನಿಮಿಷ ಚೆನ್ನಾಗಿ ಕಲಸಿ ಬೇಯಿಸಿ.</li>
      <li>ಸೆವಿಂಗ್ ಮುನ್ನ ಕೊತ್ತಂಬರಿ ಮತ್ತು ನಿಂಬೆ ರಸ ಅಲಂಕರಿಸಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 141, name: "Poha", link: "vegan/ve13.php", image: "../food_image/recipes/poha.jpg" };

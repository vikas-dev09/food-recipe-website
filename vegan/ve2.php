...
<title>Kala Chana Curry | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Kala Chana Curry</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegan/vag2.jpg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ve2">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      <li>1 cup kala chana (black chickpeas), soaked overnight</li>
    ...
    <ol data-lang="en">
      <li>Cook soaked kala chana until soft.</li>
      <li>Heat oil, add cumin seeds and sauté onions.</li>
      <li>Add tomato puree, turmeric, coriander powder, garam masala, salt; cook 5–7 min.</li>
      <li>Add cooked kala chana and simmer 10 min.</li>
      <li>Garnish with coriander and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ನೆನೆಸಿದ ಕಾಳ ಚಣವನ್ನು ಚೆನ್ನಾಗಿ ಬೇಯಿಸಿ.</li>
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ ಜೀರೆ ಹಾಕಿ ಈರುಳ್ಳಿಯನ್ನು ಹುರಿ.</li>
      <li>ಟೊಮೆಟೋ ಪ್ಯೂರಿ, ಹಳದಿ, ಧನಿಯಾ ಪುಡಿ, ಗರಂ ಮಸಾಲಾ, ಉಪ್ಪು ಸೇರಿಸಿ 5–7 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಬೇಯಿಸಿದ ಕಾಳ ಚಣ ಸೇರಿಸಿ 10 ನಿಮಿಷ ಕುಡಿಸಿ.</li>
...
const recipeData={id:130,name:"Kala Chana Curry",link:"vegan/ve2.php",image:"../food_image/recipes/kala_chana_curry.jpg"};

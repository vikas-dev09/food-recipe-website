...
<title>Cabbage Sabzi | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Cabbage Sabzi</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegan/vag14.jpg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ve3">  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>2 ಕಪ್ ಸೌತೆಕಾಯಿಯು, ಚೂರಿ ಮಾಡಿದ</li>
    ...
    <h2 data-lang="en">Steps to Make Cabbage Sabzi</h2>
    <h2 data-lang="kn" style="display:none;">ಸೌತೆಕಾಯಿ ಸಬ್ಜಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat oil in a pan, add mustard seeds, and let them splutter.</li>
      <li>Add chopped onions and green chilies, sauté till soft.</li>
      <li>Add cabbage, turmeric, and salt. Cook until cabbage is tender.</li>
      <li>Garnish with coriander and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಪ್ಯಾನ್‌ನಲ್ಲಿ ಎಣ್ಣೆ ಬಿಸಿಲು ಮಾಡಿ, ಆದು ಬೀಜ ಹಾಕಿ ಪಟಾಕಿ ಬಾರುವಂತೆ ಮಾಡಿ.</li>
      <li>ಚೂರು ಮಾಡಿದ ಈರುಳ್ಳಿ ಮತ್ತು ಹಸಿರು ಮೆಣಸು ಸೇರಿಸಿ, ಮೃದುವಾಗುವವರೆಗೆ ಬಾಡಿಸಿ.</li>
      <li>ಸೌತೆಕಾಯಿ, ಹಳದಿ, ಉಪ್ಪು ಸೇರಿಸಿ. ಸೌತೆಕಾಯಿ ನরমಾಗುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
...
<script>
  ...
  const recipeData = { id: 142, name: "Cabbage Sabzi", link: "vegan/ve14.php", image: "../food_image/recipes/cabbage_sabzi.jpg" };

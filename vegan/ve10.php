...
<div class="container">
  ...
  <h1>Jeera Rice</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegan/vag10.jpg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ve3">  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>1 ಟೀಸ್ಪೂನ್ ಸಾಸಿವೆ (ಜೀರಿಗೆ)</li>
      <li>1 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಎಣ್ಣೆ ಅಥವಾ ಘೀ (ಐಚ್ಛಿಕ)</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ ತಕ್ಕಂತೆ</li>
      <li>ತಾಜಾ ಕೊತ್ತಂಬರಿ ಅಲಂಕರಿಸಲು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Jeera Rice</h2>
    <h2 data-lang="kn" style="display:none;">ಜೀರೆ ಅಕ್ಕಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Wash and soak rice for 30 minutes.</li>
      <li>Heat oil/ghee, add cumin seeds and sauté briefly.</li>
      <li>Add rice, water, and salt. Cook until done.</li>
      <li>Garnish with coriander and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಅಕ್ಕಿ ತೊಳಸಿ 30 ನಿಮಿಷ ನೆನೆಸಿಡಿ.</li>
      <li>ಎಣ್ಣೆ/ಘೀ ಬಿಸಿಲು ಮಾಡಿ, ಸಾಸಿವೆ ಹಾಕಿ ಸ್ವಲ್ಪ ಬಾಡಿಸಿ.</li>
      <li>ಅಕ್ಕಿ, ನೀರು ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ; ಚೆನ್ನಾಗಿ ಬೇಯಿಸಿ.</li>
    ...
    <table data-lang="en">
      ...
      <tr><td>Carbohydrates</td><td>44 g</td></tr>
    ...
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಕಾರ್ಬೊಹೈಡ್ರೇಟ್ಸ್</td><td>44 g</td></tr>
...
<script>
  ...
  const recipeData = { id: 138, name: "Jeera Rice", link: "vegan/ve10.php", image: "../food_image/recipes/jeera_rice.jpg" };

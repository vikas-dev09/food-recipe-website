...
<div class="container">
  ...
  <h1>Bhel Puri</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegan/vag12.jpeg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ve3">  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>Salt and chaat masala to taste</li>
    </ul>
    <ul data-lang="kn" style="display:none;">
      <li>2 ಕಪ್ ಪಫ್ಡ್ ರೈಸ್</li>
      <li>1/2 ಕಪ್ ಸೇವು</li>
      <li>1 ಈರುಳ್ಳಿ, ಚೆನ್ನಾಗಿ ಕತ್ತರಿಸಿದ</li>
      <li>1 ಟೊಮೇಟೋ, ಕತ್ತರಿಸಿದ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಕೊತ್ತಂಬರಿ, ಕತ್ತರಿಸಿದ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಹತ್ತಿಗೆ ಚಟ್ನಿ</li>
      <li>1 ಟೇಬಲ್‌ಸ್ಪೂನ್ ನಿಂಬೆ ರಸ</li>
      <li>ಉಪ್ಪು ಮತ್ತು ಚಾಟ್ ಮಸಾಲಾ ರುಚಿಗೆ ತಕ್ಕಂತೆ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Bhel Puri</h2>
    <h2 data-lang="kn" style="display:none;">ಭೇಲ್ ಪುರಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>In a bowl, combine puffed rice, chopped onion, tomato, and coriander.</li>
      <li>Add tamarind chutney, lemon juice, salt, and chaat masala.</li>
      <li>Mix well and garnish with sev on top.</li>
      <li>Serve immediately.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಒಂದು ಬಟ್ಟಲಿನಲ್ಲಿ ಪಫ್ಡ್ ರೈಸ್, ಈರುಳ್ಳಿ, ಟೊಮೇಟೋ ಮತ್ತು ಕೊತ್ತಂಬರಿ ಸೇರಿಸಿ.</li>
      <li>ಹತ್ತಿಗೆ ಚಟ್ನಿ, ನಿಂಬೆ ರಸ, ಉಪ್ಪು ಮತ್ತು ಚಾಟ್ ಮಸಾಲಾ ಸೇರಿಸಿ.</li>
      <li>ಚೆನ್ನಾಗಿ ಕಲಸಿ ಮೇಲೆ ಸೇವು ಹಾಕಿ ಅಲಂಕರಿಸಿ.</li>
      <li>ತಕ್ಷಣ ಸೇವಿಸಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 140, name: "Bhel Puri", link: "vegan/ve12.php", image: "../food_image/recipes/bhel_puri.jpg" };

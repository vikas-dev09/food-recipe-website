...
<title>Vankaya Pachadi | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Vankaya Pachadi</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegan/vag5.webp"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ve5">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      <li>2 medium-sized eggplants (brinjal)</li>
      <li>2 tbsp oil</li>
    ...
    <ul data-lang="kn" style="display:none;">
      <li>2 ಮಧ್ಯಮ ಎತ್ತರದ ಬದನೆಕಾಯಿ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಎಣ್ಣೆ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಅಲೆಹುಣಸೆ ಬೀಜ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಜೀರೆ</li>
      <li>2 ಹಸಿರು ಮೆಣಸು, ಚೂರು ಮಾಡಿದ</li>
    ...
    <ol data-lang="en">
      <li>Roast or steam eggplants until soft.</li>
      <li>Heat oil, add mustard seeds and cumin seeds.</li>
      <li>Add green chilies, turmeric, and salt; sauté briefly.</li>
      <li>Add roasted eggplants, mash slightly, cook 5–7 min.</li>
      <li>Garnish with coriander and serve.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಬದನೆಕಾಯಿಗಳನ್ನು ಚೆನ್ನಾಗಿ ಬಿಸಿ ಮಾಡಿ ಅಥವಾ ಸ್ಟೀಮ್ ಮಾಡಿ.</li>
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ ಅಲೆಹುಣಸೆ ಮತ್ತು ಜೀರೆ ಹಾಕಿ.</li>
      <li>ಹಸಿರು ಮೆಣಸು, ಹಳದಿ, ಉಪ್ಪು ಸೇರಿಸಿ ಸ್ವಲ್ಪ ಹುರಿ.</li>
      <li>ಬದನೆಕಾಯಿ ಸೇರಿಸಿ ಸ್ವಲ್ಪ ಒಣಗಿಸಿ 5–7 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಕೊತ್ತಂಬರಿ ಹಾಕಿ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
...
const recipeData={id:133,name:"Vankaya Pachadi",link:"vegan/ve5.php",image:"../food_image/recipes/vankaya_pachadi.jpg"};

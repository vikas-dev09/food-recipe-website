...
<title>Lobia Masala | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Lobia Masala</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegan/vag1.jpg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ve1">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      <li>1 cup black-eyed beans (lobia), soaked overnight</li>
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಲೋಬಿಯಾ, ರಾತ್ರಿ ನೆನೆಸಿಡಿ</li>
    ...
    <ol data-lang="en">
      <li>Cook soaked lobia until soft.</li>
      <li>Heat oil, add cumin seeds and sauté onions.</li>
      <li>Add tomato puree, turmeric, garam masala, salt; cook 5–7 min.</li>
      <li>Add cooked lobia and simmer 10 min.</li>
      <li>Garnish with coriander and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ನೆನೆಸಿದ ಲೋಬಿಯಾವನ್ನು ಚೆನ್ನಾಗಿ ಬೇಯಿಸಿ.</li>
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ ಜೀರೆ ಹಾಕಿ ಈರುಳ್ಳಿಯನ್ನು ಹುರಿ.</li>
      <li>ಟೊಮೆಟೋ ಪ್ಯೂರಿ, ಹಳದಿ, ಗರಂ ಮಸಾಲಾ, ಉಪ್ಪು ಸೇರಿಸಿ 5–7 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಬೇಯಿಸಿದ ಲೋಬಿಯಾ ಸೇರಿಸಿ 10 ನಿಮಿಷ ಕುಡಿಸಿ.</li>
...
const recipeData={id:129,name:"Lobia Masala",link:"vegan/ve1.php",image:"../food_image/recipes/lobia_masala.jpg"};

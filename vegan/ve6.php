...
<title>Lauki Chana Dal | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Lauki Chana Dal</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegan/vag6.jpg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ve6">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>1 cup Lauki (bottle gourd), chopped</li>
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಚಣಾ ದಾಲ್</li>
      <li>1 ಕಪ್ ಲೌಕಿ, ಚಾಪ್ ಮಾಡಿದ</li>
    ...
    <h2 data-lang="en">Steps to Make Lauki Chana Dal</h2>
    <h2 data-lang="kn" style="display:none;">ಲೌಕಿ ಚಣಾ ದಾಲ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Wash chana dal and soak 30 minutes.</li>
      <li>Heat oil, sauté onion and green chilies.</li>
      <li>Add turmeric, lauki, dal, salt, and water; cook till soft.</li>
      <li>Garnish with coriander and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಚಣಾ ದಾಲ್ ತೊಳಸಿ 30 ನಿಮಿಷ ನೆನೆಸಿಡಿ.</li>
      <li>ಎಣ್ಣೆ ಬಿಸಿಲು ಮಾಡಿ, ಈರುಳ್ಳಿ ಮತ್ತು ಹಸಿರು ಮೆಣಸು ಬಾಡಿಸಿ.</li>
      <li>ಹಳದಿ, ಲೌಕಿ, ದಾಲ್, ಉಪ್ಪು ಮತ್ತು ನೀರು ಸೇರಿಸಿ; ಬೆಲ್ಲುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
...
<script>
  ...
  const recipeData = { id: 134, name: "Lauki Chana Dal", link: "vegan/ve6.php", image: "../food_image/recipes/lauki_chana_dal.jpg" };

...
<div class="container">
  ...
  <h1>Lemon Rice</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/vegan/vag7.jpg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ve7">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>1 ಟೇಬಲ್‌ಸ್ಪೂನ್ ನಿಂಬು ಹಣ್ಣು ರಸ</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಹಳದಿ ಪುಡಿ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಸಾಸಿವೆ</li>
      <li>2 ಒಣ ಕೆಂಪು ಮೆಣಸು</li>
    ...
    <h2 data-lang="kn" style="display:none;">ನಿಂಬು ಅಕ್ಕಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat oil, add mustard seeds and red chilies.</li>
      <li>Add turmeric and sauté for a few seconds.</li>
      <li>Mix in cooked rice, lemon juice, and salt.</li>
      <li>Garnish with coriander and serve.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಎಣ್ಣೆ ಬಿಸಿಲು ಮಾಡಿ, ಸಾಸಿವೆ ಮತ್ತು ಕೆಂಪು ಮೆಣಸು ಹಾಕಿ.</li>
      <li>ಹಳದಿ ಸೇರಿಸಿ ಮತ್ತು ಕೆಲವು ಸೆಕೆಂಡುಗಳ ಕಾಲ ಬಾಡಿಸಿ.</li>
      <li>ಬೇಯಿಸಿದ ಅಕ್ಕಿ, ನಿಂಬು ರಸ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ ಕಲಸಿ.</li>
...
<script>
  ...
  const recipeData = { id: 135, name: "Lemon Rice", link: "vegan/ve7.php", image: "../food_image/recipes/lemon_rice.jpg" };

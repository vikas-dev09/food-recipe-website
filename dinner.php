...
<head>
  ...
  <title>Foodies - Egg Recipes</title>
  <!-- Google Fonts -->
...
<body>
    ...
    <div class="nav-section">
      ...
      <div class="search-wrap">
        <div class="search-box">
          <input id="searchInput" type="text" placeholder="Search eggs recipes (try: egg curry)" autocomplete="off" />
  ...
  <div class="grid-container">
    ...
    <div class="card">
      <img src="food_image/dinner/dn1.jpg" alt="Vegetable Biryani" />
      <div class="card-body">
        <h5 class="card-title">Vegetable Biryani</h5>
        <p class="card-text">Aromatic rice with mixed vegetables and fragrant spices.</p>
        <a href="dinner/d1.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/dinner/dn2.jpeg" alt="Jeera Rice" />
      <div class="card-body">
        <h5 class="card-title">Jeera Rice</h5>
        <p class="card-text">Simple cumin-flavored basmati rice, perfect with curries.</p>
        <a href="dinner/d2.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/dinner/dn3.jpeg" alt="Pulao" />
      <div class="card-body">
        <h5 class="card-title">Pulao</h5>
        <p class="card-text">Flavored rice cooked with vegetables and mild spices.</p>
        <a href="dinner/d3.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/dinner/dn4.jpg" alt="Tamarind Rice" />
      <div class="card-body">
        <h5 class="card-title">Tamarind Rice</h5>
        <p class="card-text">Tangy and spicy South Indian rice with tamarind paste.</p>
        <a href="dinner/d4.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/dinner/dn5.jpeg" alt="Lemon Rice" />
      <div class="card-body">
        <h5 class="card-title">Lemon Rice</h5>
        <p class="card-text">Fragrant rice with lemon juice, turmeric, and curry leaves.</p>
        <a href="dinner/d5.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/dinner/dn6.jpeg" alt="Tomato Rice" />
      <div class="card-body">
        <h5 class="card-title">Tomato Rice</h5>
        <p class="card-text">Spiced rice cooked with fresh tomatoes and mild seasonings.</p>
        <a href="dinner/d6.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/dinner/dn7.jpeg" alt="Curd Rice" />
      <div class="card-body">
        <h5 class="card-title">Curd Rice</h5>
        <p class="card-text">Cooling rice mixed with yogurt, tempered with spices.</p>
        <a href="dinner/d7.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/dinner/dn8.jpeg" alt="Sambar Rice" />
      <div class="card-body">
        <h5 class="card-title">Sambar Rice</h5>
        <p class="card-text">Rice cooked with lentil-based sambar and vegetables.</p>
        <a href="dinner/d8.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/dinner/dn9.jpeg" alt="Coconut Rice" />
      <div class="card-body">
        <h5 class="card-title">Coconut Rice</h5>
        <p class="card-text">Fragrant rice with grated coconut and mild seasonings.</p>
        <a href="dinner/d9.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/dinner/dn10.jpeg" alt="Egg Pulao" />
      <div class="card-body">
        <h5 class="card-title">Egg Pulao</h5>
        <p class="card-text">Basmati rice cooked with spiced boiled eggs.</p>
        <a href="dinner/d10.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/dinner/dn11.jpeg" alt="Paneer Pulao" />
      <div class="card-body">
        <h5 class="card-title">Paneer Pulao</h5>
        <p class="card-text">Aromatic rice with cubes of soft paneer and spices.</p>
        <a href="dinner/d11.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/dinner/dn12.jpg" alt="Mushroom Pulao" />
      <div class="card-body">
        <h5 class="card-title">Mushroom Pulao</h5>
        <p class="card-text">Flavored rice with tender mushrooms and aromatic spices.</p>
        <a href="dinner/d12.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/dinner/dn13.jpeg" alt="Veg Fried Rice" />
      <div class="card-body">
        <h5 class="card-title">Veg Fried Rice</h5>
        <p class="card-text">Stir-fried rice with mixed vegetables and light soy seasoning.</p>
        <a href="dinner/d13.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/dinner/dn14.jpeg" alt="Spinach Rice" />
      <div class="card-body">
        <h5 class="card-title">Spinach Rice</h5>
        <p class="card-text">Nutritious rice cooked with pureed spinach and mild spices.</p>
        <a href="dinner/d14.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/dinner/dn15.jpg" alt="Kashmiri Pulao" />
      <div class="card-body">
        <h5 class="card-title">Kashmiri Pulao</h5>
        <p class="card-text">Sweet and aromatic rice with dry fruits and saffron.</p>
        <a href="dinner/d15.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/dinner/dn16.jpeg" alt="Khichdi" />
      <div class="card-body">
        <h5 class="card-title">Khichdi</h5>
        <p class="card-text">Comforting one-pot dish of rice and lentils, lightly spiced.</p>
        <a href="dinner/d16.php" class="view-btn">View Recipe</a>
      </div>
    </div>
 ...
 "payasam": "sweet/s16.php"
    ...
    input.addEventListener('input', () => {
      ...
      const matches = Object.keys(recipes).filter(k => k.includes(query)).slice(0,8);
      if (matches.length > 0) {
        ...
        noRes.textContent = `❌ No recipes found for "${query}"`;
    ...
    input.addEventListener('keydown', (e) => {
      ...
      if (e.key === 'ArrowDown') {
        ...
        e.preventDefault();
        if (active) selectRecipe(active.getAttribute('data-name'));
      }
    });
    function selectRecipe(name) {
      if (!name || !recipes[name]) return;
      showLoader();
      setTimeout(() => { window.location.href = recipes[name]; }, 500);
    }
    document.getElementById('searchBtn').onclick = () => {
      const query = document.getElementById('searchInput').value.trim().toLowerCase();
      if (!query) { showNotFoundModal("(empty search)"); return; }
      const matchedKey = Object.keys(recipes).find(k => k.includes(query));
      if (matchedKey) {
        showLoader();
        setTimeout(() => { window.location.href = recipes[matchedKey]; }, 500);
      } else {

...
<title>Masala Omelette | Foodies</title>
<style>
...
<div class="container">
  ...
  <div class="food-img">
  <img src="/food_recipe/food_image/egg/eg2.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="e2">
s  </div>
  ...
  <div id="recipe-content">
    ...
    <h2 data-lang="en">Steps to Make Masala Omelette</h2>
    <h2 data-lang="kn" style="display:none;">ಮಸಾಲೆ ಓಮ್ಲೆಟ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Crack the eggs into a bowl and beat well.</li>
      <li>Add chopped onion, tomato, green chili, coriander, turmeric, chili powder, and salt.</li>
      <li>Whisk everything until combined.</li>
      <li>Heat oil or butter in a pan over medium heat.</li>
      <li>Pour the egg mixture into the pan and spread evenly.</li>
      <li>Cook for 2–3 minutes on one side until golden.</li>
      <li>Flip and cook the other side until done.</li>
      <li>Serve hot with toast or tea.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಮೊಟ್ಟೆಗಳನ್ನು ಒಂದು ಬೌಲ್‌ನಲ್ಲಿ ಒಡೆದು ಚೆನ್ನಾಗಿ ಬಡಿ.</li>
      <li>ಈರುಳ್ಳಿ, ಟೊಮೇಟೋ, ಹಸಿಮೆಣಸಿನಕಾಯಿ, ಕೊತ್ತಂಬರಿ, ಹಳದಿ ಪುಡಿ, ಮೆಣಸು ಪುಡಿ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ.</li>
      <li>ಎಲ್ಲವನ್ನು ಒಟ್ಟಿಗೆ ಚೆನ್ನಾಗಿ ಮಿಶ್ರಣಿಸಿ.</li>
      <li>ಮಧ್ಯಮ ಉರಿಯಲ್ಲಿ ಪ್ಯಾನ್‌ನಲ್ಲಿ ಎಣ್ಣೆ ಅಥವಾ ಬೆಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ.</li>
      <li>ಮೊಟ್ಟೆ ಮಿಶ್ರಣವನ್ನು ಪ್ಯಾನ್‌ಗೆ ಸುರಿದು ಸಮವಾಗಿ ಹಂಚಿ.</li>
      <li>ಒಂದು ಬದಿಯನ್ನು 2–3 ನಿಮಿಷಗಳು ಬಂಗಾರದ ಬಣ್ಣದವರೆಗೆ ಬೇಯಿಸಿ.</li>
      <li>ಹತ್ತಿರದ ಬದಿಯನ್ನು ತಿರುಗಿಸಿ ಬೇಯಿಸಿ.</li>
      <li>ಬಿಸಿ ಬಿಸಿ ಓಮ್ಲೆಟ್ ಅನ್ನು ಟೋಸ್ಟ್ ಅಥವಾ ಚಹಾ ಜೊತೆ ಸವಿಯಿರಿ.</li>
    </ol>
    ...
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಸೋಡಿಯಂ</td><td>300 mg</td></tr>
    </table>
...
<script>
  ...
  const recipeData = { id: 2, name: "Masala Omelette", link: "egg/e2.php", image: "../food_image/egg/masala_omelette.jpg" };

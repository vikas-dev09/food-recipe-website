...
<div class="container">
  ...
  <h1>Egg Chaat</h1>
  <div class="food-img">
  <img src="/food_recipe/food_image/egg/eg10.jpeg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="e10">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      <li>4 boiled eggs (cut into halves)</li>
      ...
      <li>Salt to taste</li>
      <li>Sev for garnish</li>
      <li>Lemon wedge for serving</li>
    </ul>
    <ul data-lang="kn" style="display:none;">
      <li>4 ಉಂಡೆ ಮೊಟ್ಟೆಗಳು (ಅರ್ಧವಾಗಿ ಕತ್ತರಿಸಿ)</li>
      ...
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಹುಣಸೆ ಚಟ್ನಿ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಹಸಿರು ಚಟ್ನಿ</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಚಾಟ್ ಮಸಾಲೆ</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಮೆಣಸು ಪುಡಿ</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ</li>
      <li>ಸೇವ್ ಅಲಂಕಾರಕ್ಕೆ</li>
      <li>ನಿಂಬೆ ತುಂಡು ಸವಿಯಲು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Egg Chaat</h2>
    <h2 data-lang="kn" style="display:none;">ಎಗ್ ಚಾಟ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Boil eggs, peel, and cut into halves.</li>
      <li>Arrange the egg halves on a serving plate.</li>
      <li>Top with chopped onion, tomato, green chili, and coriander leaves.</li>
      <li>Drizzle tamarind and green chutneys over the eggs.</li>
      <li>Sprinkle salt, red chili powder, and chaat masala.</li>
      <li>Garnish with sev and a squeeze of lemon.</li>
      <li>Serve immediately for best taste.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಮೊಟ್ಟೆಗಳನ್ನು ಉಡಿ, ತೊಲೆ ತೆಗೆದು ಅರ್ಧವಾಗಿ ಕತ್ತರಿಸಿ.</li>
      <li>ಸೇವೆಯ ತಟ್ಟೆಯಲ್ಲಿ ಮೊಟ್ಟೆ ತುಂಡುಗಳನ್ನು ಹಾಸಿ.</li>
      <li>ಈರುಳ್ಳಿ, ಟೊಮೇಟೋ, ಹಸಿಮೆಣಸಿನಕಾಯಿ ಮತ್ತು ಕೊತ್ತಂಬರಿ ಎಲೆಗಳನ್ನು ಮೇಲಿನಿಂದ ಹಾಕಿ.</li>
      <li>ಹುಣಸೆ ಚಟ್ನಿ ಮತ್ತು ಹಸಿರು ಚಟ್ನಿ ಸುರಿಸಿ.</li>
      <li>ಉಪ್ಪು, ಮೆಣಸು ಪುಡಿ ಮತ್ತು ಚಾಟ್ ಮಸಾಲೆ ಚೆಲ್ಲಿ.</li>
      <li>ಮೇಲಿಂದ ಸೇವ್ ಮತ್ತು ನಿಂಬೆ ರಸ ಸುರಿಸಿ ಅಲಂಕರಿಸಿ.</li>
      <li>ತಕ್ಷಣವೇ ಸವಿಯಿರಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 10, name: "Egg Chaat", link: "egg/e10.php", image: "../food_image/egg/egg_chaat.jpg" };

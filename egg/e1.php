...
<style>
  * { box-sizing: border-box; }
  ...
  /* ✨ Small gold-gradient language button */
  .lang-btn {
...
<div class="container">
  ...
  <h1>Egg Curry</h1>
  <div class="food-img">
  <img src="/food_recipe/food_image/egg/eg1.jpg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="e1">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>1/2 cup coconut milk or water</li>
      <li>Salt to taste</li>
      <li>Fresh coriander for garnish</li>
    </ul>
    <ul data-lang="kn" style="display:none;">
      <li>4 ಕುದಿತ ಮೊಟ್ಟೆಗಳು</li>
      <li>2 ಈರುಳ್ಳಿ (ಸೂಕ್ಷ್ಮವಾಗಿ ನುಗ್ಗಿಸಬೇಕು)</li>
      ...
      <li>1/2 ಕಪ್ ತೆಂಗಿನ ಹಾಲು ಅಥವಾ ನೀರು</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ</li>
      <li>ಹಸಿರು ಕೊತ್ತಂಬರಿ ಅಲಂಕಾರಕ್ಕೆ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Egg Curry</h2>
    <h2 data-lang="kn" style="display:none;">ಮೊಟ್ಟೆ ಕರಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      ...
      <li>Pour coconut milk or water and simmer for 5 minutes.</li>
      <li>Add boiled eggs, gently stir, and simmer for another 5 minutes.</li>
      <li>Garnish with coriander and serve hot with rice or roti.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ ಜೀರಿಗೆ ಹಾಕಿ.</li>
      <li>ಈರುಳ್ಳಿಗಳನ್ನು ಸೇರಿಸಿ ಬಂಗಾರದ ಬಣ್ಣದವರೆಗೆ ಬಾಡಿಸಿ.</li>
      ...
      <li>ತೆಂಗಿನ ಹಾಲು ಅಥವಾ ನೀರು ಸೇರಿಸಿ 5 ನಿಮಿಷ ಕುದಿಸಿ.</li>
      <li>ಮೊಟ್ಟೆಗಳು ಸೇರಿಸಿ ಮತ್ತೊಂದು 5 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಕೊತ್ತಂಬರಿ ಹಾಕಿ ಬಿಸಿ ಅನ್ನ ಅಥವಾ ರೋಟಿ ಜೊತೆ ಸವಿಯಿರಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 1, name: "Egg Curry", link: "egg/e1.php", image: "../food_image/egg/eg4.jpg" };

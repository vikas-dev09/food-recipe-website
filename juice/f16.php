...
<title>Ginger-Lemon Juice | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Ginger-Lemon Juice</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/jucie/ju16.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ju16">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      <li>2 lemons</li>
      <li>1-inch fresh ginger piece</li>
      <li>2 tbsp honey or sugar (optional)</li>
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>1-ಇಂಚಿನ تازಾ ಶುಂಗಾದಿ ಕಡ್ಡಿ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಜೇನುತುಪ್ಪ ಅಥವಾ ಸಕ್ಕರೆ (ಐಚ್ಛಿಕ)</li>
      <li>2 ಕಪ್ ತಂಪು ನೀರು</li>
      <li>ಐಸ್ ಕ್ಯೂಬ್‌ಗಳು</li>
      <li>ಗಾರ್ನಿಷ್ ಮಾಡಲು ಪುದೀನಾ ಎಲೆಗಳು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Ginger-Lemon Juice</h2>
    <h2 data-lang="kn" style="display:none;">ಶುಂಗಾದಿ-ನಿಂಬೆ ರಸ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Peel ginger and grate it finely.</li>
      <li>Juice the lemons into a bowl.</li>
      <li>Add grated ginger, honey/sugar, and a little water. Stir well.</li>
      <li>Mix with remaining cold water and stir.</li>
      <li>Pour into glasses, add ice cubes, and garnish with mint leaves.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಶುಂಗಾದಿಯನ್ನು ತೋಳಿಸಿ ಸಣ್ಣದಾಗಿ ಬೆರೆಯಿರಿ.</li>
      <li>ನಿಂಬೆ ಹಣ್ಣಿನ ರಸವನ್ನು ಬೌಲ್‌ಗೆ ಹಾಕಿ.</li>
      <li>ಬೆರಸಿದ ಶುಂಗಾದಿ, ಜೇನುತುಪ್ಪ/ಸಕ್ಕರೆ, ಸ್ವಲ್ಪ ನೀರನ್ನು ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಕಲಸಿ.</li>
      <li>ಉಳಿದ ತಂಪು ನೀರನ್ನು ಸೇರಿಸಿ ಕಲಸಿ.</li>
      <li>ಗ್ಲಾಸ್‌ಗಳಲ್ಲಿ ಸುರಿದು ಐಸ್ ಕ್ಯೂಬ್‌ಗಳನ್ನು ಸೇರಿಸಿ, ಪುದೀನಾ ಎಲೆಗಳಿಂದ ಅಲಂಕರಿಸಿ ಸೇವಿಸಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 32, name: "Ginger-Lemon Juice", link: "juice/f16.php", image: "../food_image/drinks/ginger_lemon_juice.jpg" };

...
<title>Beetroot Juice | Foodies</title>
<style>
...
<div class="container">
  ...
  <div class="food-img">
<img src="/food_recipe/food_image/jucie/ju13.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ju13">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      <li>2 medium beetroot, peeled and chopped</li>
      <li>1/2 cup water</li>
    ...
    <ul data-lang="kn" style="display:none;">
      <li>2 ಮಧ್ಯಮ ಬೀನ್ರೂಟ್, ತೊಳೆದು ತುಂಡುಗಳಾಗಿ ಕತ್ತರಿಸಿದವು</li>
      <li>1/2 ಕಪ್ ನೀರು</li>
    ...
    <h2 data-lang="en">Steps to Make Beetroot Juice</h2>
    <h2 data-lang="kn" style="display:none;">ಬೀಟ್ರೂಟ್ ಜ್ಯೂಸ್ ತಯಾರಿಸುವ ವಿಧಾನ</h2>
    <ol data-lang="en">
      <li>Blend chopped beetroot with water until smooth.</li>
      <li>Strain the juice using a fine mesh or cheesecloth.</li>
      <li>Add lemon juice and honey or sugar if desired. Mix well.</li>
      <li>Pour into glasses with ice cubes and serve fresh.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಕತ್ತರಿಸಿದ ಬೀಟ್ರೂಟ್ ಮತ್ತು ನೀರನ್ನು ಮಿಕ್ಸರ್‌ನಲ್ಲಿ ನುಣ್ಣಗೆ ರುಬ್ಬಿ.</li>
      <li>ರುಬ್ಬಿದ ರಸವನ್ನು ಚಿಲ್ಲಿ ಅಥವಾ ಬಟ್ಟೆಯಿಂದ ಚಲ್ಲಿಸಿ.</li>
      <li>ನಿಂಬೆ ರಸ ಮತ್ತು ಜೇನು ಅಥವಾ ಸಕ್ಕರೆ ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಕಲಸಿ.</li>
    ...
    <table data-lang="en">
      ...
      <tr><td>Carbohydrates</td><td>23 g</td></tr>
    ...
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಕಾರ್ಬೊಹೈಡ್ರೇಟ್ಸ್</td><td>23 g</td></tr>
      <tr><td>ಪ್ರೋಟೀನ್</td><td>2 g</td></tr>
      <tr><td>ಕೊಬ್ಬು</td><td>0.2 g</td></tr>
      <tr><td>ಸಕ್ಕರೆ</td><td>18 g</td></tr>
      <tr><td>ನಾರು</td><td>3 g</td></tr>
    </table>
...
<script>
  ...
  const recipeData = { id: 29, name: "Beetroot Juice", link: "juice/j13.php", image: "../food_image/juice/beetroot_juice.jpg" };

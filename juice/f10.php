...
<title>Mosambi Juice | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Mosambi Juice</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/jucie/ju10.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ju10">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      <li>4 Mosambi (sweet lime) fruits</li>
    ...
    <ul data-lang="kn" style="display:none;">
      <li>4 ಮೋಸಂಬಿ ಹಣ್ಣುಗಳು</li>
      <li>2 ಟೀಸ್ಪೂನ್ ಸಕ್ಕರೆ (ರುಚಿಗೆ ತಕ್ಕಂತೆ)</li>
      <li>1/4 ಟೀಸ್ಪೂನ್ ಉಪ್ಪು</li>
      <li>1 ಕಪ್ ತಂಪು ನೀರು</li>
      <li>ಐಸ್ ಕ್ಯೂಬ್‌ಗಳು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Mosambi Juice</h2>
    <h2 data-lang="kn" style="display:none;">ಮೋಸಂಬಿ ಜ್ಯೂಸ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Peel and deseed the Mosambi fruits.</li>
      <li>Extract juice using a juicer or manually in a bowl.</li>
      <li>Add sugar, salt, and cold water. Mix well until sugar dissolves.</li>
      <li>Pour into glasses and add ice cubes.</li>
      <li>Serve chilled for a refreshing drink!</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಮೋಸಂಬಿ ಹಣ್ಣುಗಳನ್ನು ತೊಳೆದು ಬೀಜಗಳನ್ನು ತೆಗೆದು ಹಾಕಿ.</li>
      <li>ಜ್ಯೂಸರ್ ಅಥವಾ ಕೈಯಿಂದ ರಸ ತೆಗೆಯಿರಿ.</li>
      <li>ಸಕ್ಕರೆ, ಉಪ್ಪು ಮತ್ತು ತಂಪು ನೀರನ್ನು ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಕಲಸಿ.</li>
      <li>ಗ್ಲಾಸ್‌ಗಳಲ್ಲಿ ಸುರಿದು ಐಸ್ ಕ್ಯೂಬ್‌ಗಳನ್ನು ಸೇರಿಸಿ.</li>
      <li>ತಂಪಾಗಿ ಸವಿಯಿರಿ!</li>
    </ol>
    ...
    <table data-lang="en">
      ...
      <tr><td>Calories</td><td>70 kcal</td></tr>
    ...
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಕ್ಯಾಲೊರಿ</td><td>70 kcal</td></tr>
...
<script>
  ...
  const recipeData = { id: 26, name: "Mosambi Juice", link: "juice/f10.php", image: "../food_image/drinks/mosambi.jpg" };

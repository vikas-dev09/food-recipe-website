...
<title>Papaya Juice | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Papaya Juice</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/jucie/ju14.jpg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="ju14">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಪಪ್ಪಾಯಿ (ಹಣ್ಣು, ಚಿರುನಿಮಿಷಗಳಲ್ಲಿ)</li>
      <li>1 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಸಕ್ಕರೆ ಅಥವಾ ತೇನೀ (ಐಚ್ಛಿಕ)</li>
      <li>1/2 ಕಪ್ ತಂಪು ನೀರು</li>
      <li>ಐಸ್ ಕ್ಯೂಬ್‌ಗಳು</li>
      <li>ಅಲಂಕರಣೆಗೆ ಪುದೀನಾ ಎಲೆಗಳು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Papaya Juice</h2>
    <h2 data-lang="kn" style="display:none;">ಪಪ್ಪಾಯಿ ಜ್ಯೂಸ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Blend papaya cubes with cold water until smooth.</li>
      <li>Add sugar or honey and mix well.</li>
      <li>Pour into glasses over ice cubes.</li>
      <li>Garnish with mint leaves and serve chilled.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಪಪ್ಪಾಯಿ ಚಿರುನಿಮಿಷಗಳನ್ನು ತಂಪು ನೀರಿನೊಂದಿಗೆ ಬ್ಲೆಂಡ್ ಮಾಡಿ ಸ್ಮೂದ್ ಆಗುವವರೆಗೆ.</li>
      <li>ಸಕ್ಕರೆ ಅಥವಾ ತೇನಿಯನ್ನು ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಮಿಶ್ರಣ ಮಾಡಿ.</li>
      <li>ಐಸ್ ಕ್ಯೂಬ್‌ಗಳ ಮೇಲೆ ಗ್ಲಾಸ್‌ಗಳಲ್ಲಿ ಸುರಿದು ಹಾಕಿ.</li>
      <li>ಪುದೀನಾ ಎಲೆಗಳಿಂದ ಅಲಂಕರಿಸಿ ತಂಪಾಗಿ ಸವಿಯಿರಿ.</li>
    </ol>
    ...
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ವಿಟಮಿನ್ C</td><td>30 mg</td></tr>
    </table>
...
<script>
  ...
  const recipeData = { id: 30, name: "Papaya Juice", link: "juice/f14.php", image: "../food_image/drinks/papaya_juice.jpg" };

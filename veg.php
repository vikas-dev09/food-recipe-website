...
<head>
  ...
  <title>Foodies - Veg Recipes</title>
...
<body>
    ...
    <div class="nav-section">
      ...
      <div class="search-wrap">
        <div class="search-box">
          <input id="searchInput" type="text" placeholder="Search recipes (try: dal)" autocomplete="off" />
 ...
 <div class="grid-container">
  ...
  <div class="card">
    <img src="food_image/vegs/veg1.jpg" alt="Dal">
    <div class="card-body">
      <h5 class="card-title">Dal</h5>
      <p class="card-text">Simple, protein-rich lentils cooked with spices.</p>
      <a href="veg/v1.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/vegs/veg2.webp" alt="Chole">
    <div class="card-body">
      <h5 class="card-title">Chole</h5>
      <p class="card-text">Spicy chickpea curry best paired with bhature.</p>
      <a href="veg/v2.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/vegs/veg3.jpeg" alt="Paneer Butter Masala">
    <div class="card-body">
      <h5 class="card-title">Paneer Butter Masala</h5>
      <p class="card-text">Rich tomato gravy with soft paneer cubes.</p>
      <a href="veg/v3.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/vegs/veg4.jpg" alt="Aloo Gobi">
    <div class="card-body">
      <h5 class="card-title">Aloo Gobi</h5>
      <p class="card-text">Dry curry made with potatoes and cauliflower.</p>
      <a href="veg/v4.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/vegs/veg5.jpg" alt="Rajma">
    <div class="card-body">
      <h5 class="card-title">Rajma</h5>
      <p class="card-text">Kidney beans simmered in spiced tomato gravy.</p>
      <a href="veg/v5.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/vegs/veg6.jpg" alt="Palak Paneer">
    <div class="card-body">
      <h5 class="card-title">Palak Paneer</h5>
      <p class="card-text">Paneer cooked in smooth spinach puree.</p>
      <a href="veg/v6.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/vegs/veg7.jpg" alt="Vegetable Pulao">
    <div class="card-body">
      <h5 class="card-title">Vegetable Pulao</h5>
      <p class="card-text">Fragrant basmati rice with mixed vegetables.</p>
      <a href="veg/v7.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/vegs/veg8.jpg" alt="Bhindi Masala">
    <div class="card-body">
      <h5 class="card-title">Bhindi Masala</h5>
      <p class="card-text">Sautéed okra cooked with onions and spices.</p>
      <a href="veg/v8.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/vegs/veg9.jpg" alt="Baingan Bharta">
    <div class="card-body">
      <h5 class="card-title">Baingan Bharta</h5>
      <p class="card-text">Smokey roasted eggplant mashed with spices.</p>
      <a href="veg/v9.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/vegs/veg10.jpeg" alt="Dosa">
    <div class="card-body">
      <h5 class="card-title">Dosa with Sambar</h5>
      <p class="card-text">Crispy rice crepe served with sambar and chutney.</p>
      <a href="veg/v10.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/vegs/veg11.webp" alt="Veg Biryani">
    <div class="card-body">
      <h5 class="card-title">Idli with Coconut Chutney</h5>
      <p class="card-text">Layered rice cooked with mixed vegetables and spices.</p>
      <a href="veg/v11.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/vegs/veg12.jpeg" alt="Poori Sabzi">
    <div class="card-body">
      <h5 class="card-title">Poori with Aloo Sabzi</h5>
      <p class="card-text">Fluffy poori served with spicy potato curry.</p>
      <a href="veg/v12.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/vegs/veg13.jpg" alt="Khichdi">
    <div class="card-body">
      <h5 class="card-title">Khichdi</h5>
      <p class="card-text">Comforting mix of rice and lentils cooked together.</p>
      <a href="veg/v13.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/vegs/veg14.jpg" alt="Thepla">
    <div class="card-body">
      <h5 class="card-title">briyani</h5>
      <p class="card-text">Gujarati flatbread made with spices and wheat flour.</p>
      <a href="veg/v14.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/vegs/veg15.jpg" alt="Roti with Mixed Veg">
    <div class="card-body">
      <h5 class="card-title">Roti with Mixed Veg Curry</h5>
      <p class="card-text">Whole wheat roti served with vegetable curry.</p>
      <a href="veg/v15.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/vegs/veg16.jpg" alt="Thepla">
    <div class="card-body">
      <h5 class="card-title">Thepla</h5>
      <p class="card-text">Light, spiced flatbread suitable for travel meals.</p>
      <a href="veg/v16.php" class="view-btn">View Recipe</a>
    </div>
  </div>
  ...
  <script>
    ...
    // Search suggestions data (veg recipes)
   const recipes = {

...
<div class="container">
  ...
  <h1>Jalebi</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/swt/sw2.jpg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="sw2">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>Sugar syrup as required</li>
      <li>Ghee or oil for frying</li>
    </ul>
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಸರ್ವಪ್ರಯೋಜನ ಹಿಟ್ಟು</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಮೊಸರು</li>
      <li>1/2 ಕಪ್ ನೀರು</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಹಳದಿ ಪುಡಿ</li>
      <li>ಆವಶ್ಯಕತೆ ಪ್ರಕಾರ ಸಕ್ಕರೆ ಸಿರಪ್</li>
      <li>ಹುರಿಯಲು ನೇಯ್ ಅಥವಾ ಎಣ್ಣೆ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Jalebi</h2>
    <h2 data-lang="kn" style="display:none;">ಜಲೆಬಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Mix flour, yogurt, turmeric, and water to form a batter.</li>
      <li>Ferment the batter for 6–8 hours.</li>
      <li>Heat ghee or oil in a pan.</li>
      <li>Pour batter in circular shapes and fry until golden.</li>
      <li>Soak fried jalebis in warm sugar syrup for a few minutes.</li>
      <li>Serve warm.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಹಿಟ್ಟು, ಮೊಸರು, ಹಳದಿ ಪುಡಿ, ನೀರನ್ನು ಕಲಸಿ ಮಿಶ್ರಣ ಮಾಡಿ.</li>
      <li>ಬ್ಯಾಟರ್ ಅನ್ನು 6–8 ಗಂಟೆಗಳ ಕಾಲ ಫರ್ಮೆಂಟ್ ಮಾಡಿ.</li>
      <li>ಪ್ಯಾನ್‌ನಲ್ಲಿ ನೇಯ್ ಅಥವಾ ಎಣ್ಣೆ ಕುದಿಸಿ.</li>
      <li>ಬ್ಯಾಟರ್ ಅನ್ನು ವೃತ್ತಾಕಾರದ ಆಕಾರದಲ್ಲಿ ಹಾಕಿ ಬಂಗಾರದ ಬಣ್ಣಕ್ಕೆ ಹುರಿಯಿರಿ.</li>
      <li>ಬಿಸಿ ಸಕ್ಕರೆ ಸಿರಪ್ನಲ್ಲಿ ಕೆಲ ನಿಮಿಷ ನೆನೆಸಿರಿ.</li>
    ...
    <table data-lang="en">
      ...
      <tr><td>Carbohydrates</td><td>60 g</td></tr>
    ...
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಕಾರ್ಬೊಹೈಡ್ರೇಟ್ಸ್</td><td>60 g</td></tr>
...
const recipeData = { id: 98, name: "Jalebi", link: "sweet/s2.php", image: "../food_image/sweet/jalebi.jpg" };

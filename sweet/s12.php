...
<div class="container">
  ...
  <h1>Malpua</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/swt/sw12.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="sw12">
  </div>
  ...
  <div id="recipe-content">
    ...
    <h2 data-lang="en">Steps to Make Malpua</h2>
    <h2 data-lang="kn" style="display:none;">ಮಲ್ಪುವ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Mix flour, semolina, sugar, cardamom, and milk into a smooth batter.</li>
      <li>Heat ghee in a pan on medium flame.</li>
      <li>Pour small portions of batter and fry until golden brown.</li>
      <li>Drain excess ghee and serve warm.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಹಿಟ್ಟು, ರವೆ, ಸಕ್ಕರೆ, ಏಲಕ್ಕಿ ಪುಡಿ ಮತ್ತು ಹಾಲನ್ನು ಮೃದುವಾದ ಬ್ಯಾಟರ್ ಆಗುವಂತೆ ಕಲಸಿ.</li>
      <li>ಮಧ್ಯಮ ಉರಿಯಲ್ಲಿ ಪ್ಯಾನ್‌ನಲ್ಲಿ ನೇಯ್ ಬಿಸಿ ಮಾಡಿ.</li>
      <li>ಬ್ಯಾಟರ್‌ನ ಸಣ್ಣ ಭಾಗಗಳನ್ನು ಹಾಕಿ ಬಂಗಾರದ ಬಣ್ಣಕ್ಕೆ ಹುರಿಯಿರಿ.</li>
      <li>ಅತಿಯಾದ ನೇಯ್ ತೆಗೆದು ಬಿಸಿ ಬಿಸಿ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
...
const recipeData = { id: 108, name: "Malpua", link: "sweet/s12.php", image: "../food_image/sweet/malpua.jpg" };

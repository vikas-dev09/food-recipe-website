...
<title>Besan Ladoo | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Besan Ladoo</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/swt/sw8.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="sw8">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>2 ಕಪ್ ಬೇಳೆ ಹಿಟ್ಟು</li>
      <li>1 ಕಪ್ ಪುಡಿ ಸಕ್ಕರೆ</li>
      <li>1/2 ಕಪ್ ghe</li>
      <li>1/4 ಟೀಸ್ಪೂನ್ ಏಲಕ್ಕಿ ಪುಡಿ</li>
      <li>ಗಾರ್ನಿಶ್‌ಗೆ ಕತ್ತರಿಸಿದ ಕಾಯಿಗಳು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Besan Ladoo</h2>
    <h2 data-lang="kn" style="display:none;">ಬೇಸನ್ ಲાડೂ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat ghee in a pan, roast besan until golden.</li>
      <li>Remove from heat and let it cool slightly.</li>
      <li>Add powdered sugar and cardamom powder, mix well.</li>
      <li>Shape into small round ladoos.</li>
      <li>Garnish with chopped nuts and serve.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಪ್ಯಾನ್‌ನಲ್ಲಿ ghe ಹಿಟ್ಟು ಬಂಗಾರದ ಬಣ್ಣಕ್ಕೆ ಹುರಿಯಿರಿ.</li>
      <li>ಹಿಟ್‌ನಿಂದ ತೆಗೆದು ಸ್ವಲ್ಪ ತಂಪಾಗಲು ಬಿಡಿ.</li>
      <li>ಪುಡಿ ಸಕ್ಕರೆ ಮತ್ತು ಏಲಕ್ಕಿ ಪುಡಿ ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಕಲಸಿ.</li>
      <li>ಸಣ್ಣ ಸುತ್ತಿನ ಲಾಡೂ ರೂಪಿಸಿರಿ.</li>
      <li>ಕತ್ತರಿಸಿದ ಕಾಯಿಗಳನ್ನು ಗಾರ್ನಿಷ್ ಮಾಡಿ ಸವಿಯಿರಿ.</li>
    </ol>
    ...
    <table data-lang="en">
      ...
      <tr><td>Fat</td><td>11 g</td></tr>
      <tr><td>Fiber</td><td>2 g</td></tr>
      <tr><td>Sodium</td><td>40 mg</td></tr>
    </table>
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಕೊಬ್ಬು</td><td>11 g</td></tr>
      <tr><td>ಫೈಬರ್</td><td>2 g</td></tr>
      <tr><td>ಸೋಡಿಯಂ</td><td>40 mg</td></tr>
    </table>
...
<script>
  ...
  const recipeData = { id: 104, name: "Besan Ladoo", link: "sweet/s8.php", image: "../food_image/sweet/besan_ladoo.jpg" };

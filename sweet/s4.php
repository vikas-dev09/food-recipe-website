...
<div class="container">
  ...
  <h1>Rasmalai</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/swt/sw4.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="sw4">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>2 tbsp saffron strands</li>
      <li>Chopped pistachios for garnish</li>
    </ul>
    <ul data-lang="kn" style="display:none;">
      <li>1 ಲೀಟರ್ ಹಾಲು</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಲಿಂಬು ರಸ</li>
      <li>1/2 ಕಪ್ ಸಕ್ಕರೆ</li>
      <li>4 ಕಪ್ ನೀರು</li>
      <li>4-5 ಏಲಕ್ಕಿ ಮೊಟ್ಟೆಗಳು, ಎಳ್ಳು ಮಾಡಿದ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಕೇಸರಿ</li>
      <li>ಉಪಕರಣಕ್ಕಾಗಿ ಬಿಸಿ ಪಿಸ್ತಾ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Rasmalai</h2>
    <h2 data-lang="kn" style="display:none;">ರಸ್ಮಾಲೈ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Boil milk and add lemon juice to make chhena.</li>
      <li>Knead chhena until smooth and shape into balls.</li>
      <li>Boil sugar syrup and cook chhena balls for 10 minutes.</li>
      <li>Boil remaining milk with sugar, cardamom, and saffron to make rabri.</li>
      <li>Soak chhena balls in rabri and refrigerate.</li>
      <li>Garnish with pistachios and serve chilled.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಹಾಲು ಕುದಿಸಿ, ಲಿಂಬು ರಸ ಸೇರಿಸಿ ಚೇನಾ ತಯಾರಿಸಿ.</li>
      <li>ಚೇನೆಯನ್ನು ಚೆನ್ನಾಗಿ ಮಸಾಜ್ ಮಾಡಿ ಬೌಲ್ಸ್ ರೂಪಿಸಿ.</li>
      <li>ಸಕ್ಕರೆ ಸಿರಪ್ನಲ್ಲಿ 10 ನಿಮಿಷ ಚೇನಾ ಬೌಲ್ಸ್ ಬೇಯಿಸಿ.</li>
      <li>ಮಿಕ್ಕ ಹಾಲು, ಸಕ್ಕರೆ, ಏಲಕ್ಕಿ, ಕೇಸರಿ ಸೇರಿಸಿ ರಬ್ರೀ ತಯಾರಿಸಿ.</li>
      <li>ಚೇನಾ ಬೌಲ್ಸ್ ಅನ್ನು ರಬ್ರೀನಲ್ಲಿ ನೆನೆಸಿ ಫ್ರಿಜ್ ಮಾಡಿ.</li>
      <li>ಪಿಸ್ತಾ ಸೇರಿಸಿ ಚಳಿ ಮಾಡಿದಂತೆ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
    ...
    <table data-lang="en">
      ...
      <tr><td>Sodium</td><td>12 mg</td></tr>
    </table>
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಸೋಡಿಯಂ</td><td>12 mg</td></tr>
    </table>
...
const recipeData = { id: 100, name: "Rasmalai", link: "sweet/s4.php", image: "../food_image/sweet/rasmalai.jpg" };

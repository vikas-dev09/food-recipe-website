...
<div class="container">
  ...
  <h1>Kheer</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/swt/sw5.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="sw5">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>Chopped almonds and cashews</li>
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>4-5 ಏಲಕ್ಕಿ ಮೊಟ್ಟೆಗಳು</li>
      <li>ಕಟ್ ಮಾಡಿದ ಬಾದಾಮಿ ಮತ್ತು ಕಾಜು</li>
      <li>ಕೇಸರಿ (ಐಚ್ಛಿಕ)</li>
    </ul>

    <h2 data-lang="en">Steps to Make Kheer</h2>
    <h2 data-lang="kn" style="display:none;">ಖೀರ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Wash rice and boil in milk until soft.</li>
      <li>Add sugar and cardamom, simmer for 5 more minutes.</li>
      <li>Add chopped nuts and saffron.</li>
      <li>Serve hot or chilled.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಅಕ್ಕಿ ತೊಳೆದ ನಂತರ ಹಾಲಿನಲ್ಲಿ ಮೃದುವಾಗುವವರೆಗೆ ಕುದಿಸಿ.</li>
      <li>ಸಕ್ಕರೆ ಮತ್ತು ಏಲಕ್ಕಿ ಸೇರಿಸಿ 5 ನಿಮಿಷ ಇನ್ನೂ ಕುದಿಸಿ.</li>
      <li>ಕಟ್ ಮಾಡಿದ ಬಾದಾಮಿ ಮತ್ತು ಕಾಜು, ಕೇಸರಿ ಸೇರಿಸಿ.</li>
...
const recipeData = { id: 101, name: "Kheer", link: "sweet/s5.php", image: "../food_image/sweet/kheer.jpg" };

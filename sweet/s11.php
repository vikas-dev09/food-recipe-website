...
<div class="container">
  ...
  <h1>Sandesh</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/swt/sw11.jpg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="sw11">
  </div>
  ...
  <div id="recipe-content">
    ...
    <h2 data-lang="en">Steps to Make Sandesh</h2>
    <h2 data-lang="kn" style="display:none;">ಸಂದೇಶ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Crumble the chhena and knead lightly until smooth.</li>
      <li>Add sugar and cardamom powder; mix well.</li>
      <li>Shape the mixture into small flat discs.</li>
      <li>Garnish with nuts and saffron strands.</li>
      <li>Serve chilled or at room temperature.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಚೆನ್ನಾವನ್ನು ಕೊಂಚಷ್ಟು ಮಸಕರು ಮತ್ತು ಮೃದುವಾಗಿ ನೆಯಡ್ ಮಾಡಿ.</li>
      <li>ಸಕ್ಕರೆ ಮತ್ತು ಏಲಕ್ಕಿ ಪುಡಿ ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಕಲಸಿ.</li>
      <li>ಮಿಶ್ರಣವನ್ನು ಸಣ್ಣ ಫ್ಲಾಟ್ ಡಿಸ್ಕ್ ಗಳಲ್ಲಿ ರೂಪಿಸಿ.</li>
      <li>ಬಾದಾಮಿ ಅಥವಾ ಪಿಸ್ತಾ ಮತ್ತು ಹಳದಿ ಹಾಕಿ ಅಲಂಕರಿಸಿ.</li>
      <li>ತಣ್ಣನೆಯಾಗಿಸಿ ಅಥವಾ ರೂಮ್ ಟೆಂಪ್ ನಲ್ಲಿ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
...
const recipeData = { id: 107, name: "Sandesh", link: "sweet/s11.php", image: "../food_image/sweet/sandesh.jpg" };

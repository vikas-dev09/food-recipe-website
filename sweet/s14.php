...
<div class="container">
  ...
  <h1>Rabri</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/swt/sw14.jpg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="sw14">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಲೀಟರ್ ಫುಲ್ ಫ್ಯಾಟ್ ಹಾಲು</li>
      <li>1/4 ಕಪ್ ಸಕ್ಕರೆ</li>
      <li>1/4 ಟೀಸ್ಪೂನ್ ಏಲಕ್ಕಿ ಪುಡಿ</li>
      <li>ಸ್ವಲ್ಪ ಹಳದಿ</li>
      <li>ಕತ್ತರಿಸಿದ ಬಾದಾಮಿ ಅಥವಾ ಪಿಸ್ತಾ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Rabri</h2>
    <h2 data-lang="kn" style="display:none;">ರಬ್ರಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Boil milk on low heat, stirring occasionally.</li>
      <li>Reduce to half and thicken.</li>
      <li>Add sugar, cardamom, and saffron; mix well.</li>
      <li>Garnish with nuts and serve chilled.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಕಡಿಮೆ ಉರಿಯಲ್ಲಿ ಹಾಲನ್ನು ಕುದಿಸಿ, ಕೆಲವೊಮ್ಮೆ ಕಲಸಿ.</li>
      <li>ಅರ್ಧಕ್ಕೆ ಇಳಿಸಿ ದಪ್ಪ ಮಾಡಿರಿ.</li>
      <li>ಸಕ್ಕರೆ, ಏಲಕ್ಕಿ ಪುಡಿ, ಹಳದಿ ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಕಲಸಿ.</li>
      <li>ಬಾದಾಮಿ/ಪಿಸ್ತಾ ಹಾಕಿ ತಣ್ಣನೆಯಾಗಿಸಿ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
    ...
    <table data-lang="en">
      ...
      <tr><td>Sodium</td><td>25 mg</td></tr>
    </table>
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಸೋಡಿಯಂ</td><td>25 mg</td></tr>
    </table>
...
const recipeData = { id: 110, name: "Rabri", link: "sweet/s14.php", image: "../food_image/sweet/rabri.jpg" };

...
<title>Gajar Halwa | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Gajar Halwa</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/swt/sw6.jpg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="sw6">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>2 ಕಪ್ ಕೊತ್ತಂಬರಿ ಗಾಜರ</li>
      <li>1 ಕಪ್ ಹಾಲು</li>
      <li>1/2 ಕಪ್ ಸಕ್ಕರೆ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ghe</li>
      <li>5-6 ಜೇನುಕಾಯಿ</li>
      <li>5-6 ಬಾದಾಮಿ</li>
      <li>1/4 ಟೀಸ್ಪೂನ್ ಏಲಕ್ಕಿ ಪುಡಿ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Gajar Halwa</h2>
    <h2 data-lang="kn" style="display:none;">ಗಾಜರ್ ಹಳ್ವಾ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat ghee in a pan and add grated carrots.</li>
      <li>Saute for 5-6 minutes until slightly soft.</li>
      <li>Add milk and cook on low heat until milk evaporates.</li>
      <li>Add sugar and cardamom powder, stir well.</li>
      <li>Add nuts and cook for 5 more minutes.</li>
      <li>Serve warm.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಒಂದು ಪ್ಯಾನ್‌ನಲ್ಲಿ ghe ಹಿಟ್ಟು ಹಾಕಿ ಗಾಜರ ಸೇರಿಸಿ.</li>
      <li>5-6 ನಿಮಿಷಗಳ ಕಾಲ sauté ಮಾಡಿ.</li>
      <li>ಹಾಲು ಸೇರಿಸಿ ಕಡಿಮೆ ಉರಿಯಲ್ಲಿ ಹಾಲು ಉದುರಿದವರೆಗೆ ಬೇಯಿಸಿ.</li>
      <li>ಸಕ್ಕರೆ ಮತ್ತು ಏಲಕ್ಕಿ ಪುಡಿ ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಕಲಸಿ.</li>
      <li>ಕಾಯಿಗಳು ಸೇರಿಸಿ 5 ನಿಮಿಷ ಇನ್ನಷ್ಟು ಬೇಯಿಸಿ.</li>
      <li>ಬಿಸಿ ಬಿಸಿ ಸವಿಯಿರಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 102, name: "Gajar Halwa", link: "sweet/s6.php", image: "../food_image/sweet/gajar_halwa.jpg" };

...
<div class="container">
  ...
  <h1>Rasgulla</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/swt/sw3.jpg"  style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="sw3">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>1 ಕಪ್ ಸಕ್ಕರೆ</li>
      <li>4 ಕಪ್ ನೀರು</li>
      <li>2-3 ಏಲಕ್ಕಿ ಮೊಟ್ಟೆಗಳು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Rasgulla</h2>
    <h2 data-lang="kn" style="display:none;">ರಸ್ಗುಲ್ಲಾ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Boil milk and add lemon juice to curdle.</li>
      <li>Drain curds and knead to smooth chhena.</li>
      <li>Shape into small balls.</li>
      <li>Boil sugar and water to make syrup.</li>
      <li>Cook balls in syrup until soft and spongy.</li>
      <li>Serve chilled or warm.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಹಾಲು ಕುದಿಸಿ, ಲಿಂಬು ರಸ ಸೇರಿಸಿ ಮೊಟ್ಟೆ ಹಿಟ್ಟು ಮಾಡಿ.</li>
      <li>ಚೇನೆಯನ್ನು ಚೆನ್ನಾಗಿ ಮಸಾಜ್ ಮಾಡಿ ಸ್ಮೂತ್ ಆಗಿಸಿ.</li>
      <li>ಸಣ್ಣ ಚೇನಾ ಬೌಲ್ಸ್ ರೂಪಿಸಿ.</li>
      <li>ಸಕ್ಕರೆ ನೀರಿನಲ್ಲಿ ಸಿರಪ್ ತಯಾರಿಸಿ.</li>
      <li>ಬೌಲ್ಸ್ ಅನ್ನು ಸಿರಪ್ನಲ್ಲಿ ಬೇಯಿಸಿ ಮೃದುವಾಗಿ ತಯಾರಿಸಿ.</li>
...
const recipeData = { id: 99, name: "Rasgulla", link: "sweet/s3.php", image: "../food_image/sweet/rasgulla.jpg" };

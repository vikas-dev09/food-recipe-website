...
<div class="container">
  ...
  <h1>Payasam</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/swt/sw16.jpg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="sw16">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>2 tbsp ghee</li>
      <li>Chopped cashews and raisins</li>
    </ul>
    <ul data-lang="kn" style="display:none;">
      <li>1 ಲೀಟರ್ ಹಾಲು</li>
      <li>1/4 ಕಪ್ ಅಕ್ಕಿ</li>
      <li>1/2 ಕಪ್ ಬೆಲ್ಲ ಅಥವಾ ಸಕ್ಕರೆ</li>
      <li>1/4 ಟೀಸ್ಪೂನ್ ಏಲಕ್ಕಿ ಪುಡಿ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ತುಪ್ಪ</li>
      <li>ಕಟ್ ಮಾಡಿದ ಕಾಜು ಮತ್ತು ದ್ರಾಕ್ಷಿ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Payasam</h2>
    <h2 data-lang="kn" style="display:none;">ಪಾಯಸ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Wash rice and cook in milk until soft.</li>
      <li>Add jaggery or sugar and simmer for 10 minutes.</li>
      <li>Add cardamom powder and ghee.</li>
      <li>Garnish with cashews and raisins.</li>
      <li>Serve warm.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಅಕ್ಕಿ ತೊಳೆದು ಹಾಲಿನಲ್ಲಿ ಮೃದುವಾಗುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
      <li>ಬೆಲ್ಲ ಅಥವಾ ಸಕ್ಕರೆ ಸೇರಿಸಿ 10 ನಿಮಿಷ ಇನ್ನೂ ಬೇಯಿಸಿ.</li>
      <li>ಏಲಕ್ಕಿ ಪುಡಿ ಮತ್ತು ತುಪ್ಪ ಸೇರಿಸಿ.</li>
      <li>ಕಟ್ ಮಾಡಿದ ಕಾಜು ಮತ್ತು ದ್ರಾಕ್ಷಿ ಸೇರಿಸಿ.</li>
      <li>ಬಿಸಿ ಮಾಡಿದಂತೆ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
...
const recipeData = { id: 112, name: "Payasam", link: "sweet/s16.php", image: "../food_image/sweet/payasam.jpg" };

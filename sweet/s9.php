...
<title>Kaju Katli | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Kaju Katli</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/swt/sw9.jpg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="sw9">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      <li>1 cup cashew nuts (soaked for 2 hours)</li>
      <li>1/2 cup sugar</li>
      <li>2 tbsp water</li>
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಕಾಜು (2 ಗಂಟೆ ನೆನೆಸಿದ)</li>
      <li>1/2 ಕಪ್ ಸಕ್ಕರೆ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ನೀರು</li>
      <li>1/4 ಟೀಸ್ಪೂನ್ ಏಲಕ್ಕಿ ಪುಡಿ</li>
      <li>ಸಿಲ್ವರ್ ಲೀಫ್ (ಐಚ್ಛಿಕ)</li>
    </ul>

    <h2 data-lang="en">Steps to Make Kaju Katli</h2>
    <h2 data-lang="kn" style="display:none;">ಕಾಜು ಕಟ್ಟ್ಲಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Grind soaked cashews to a fine powder.</li>
      <li>Boil sugar and water to make a syrup.</li>
      <li>Add cashew powder and cook until thick.</li>
      <li>Roll the mixture into a thin sheet and cut into diamonds.</li>
      <li>Apply silver leaf if desired.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ನೆನೆಸಿದ ಕಾಜುವನ್ನು ಪೌಡರ್ ಮಾಡಿ.</li>
      <li>ಸಕ್ಕರೆ ಮತ್ತು ನೀರನ್ನು ಕುದಿಸಿ ಸಿರಪ್ ತಯಾರಿಸಿ.</li>
      <li>ಕಾಜು ಪುಡಿ ಸೇರಿಸಿ ದಟ್ಟವಾಗುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
      <li>ಮಿಶ್ರಣವನ್ನು ತೆಳುವಾದ ಶೀಟ್ ಆಗಿ ರೋಲ್ ಮಾಡಿ, ಹೀರಾಳು ಆಕಾರದಲ್ಲಿ ಕತ್ತರಿಸಿ.</li>
      <li>ಐಚ್ಛಿಕವಾಗಿ ಸಿಲ್ವರ್ ಲೀಫ್ ಹಚ್ಚಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 105, name: "Kaju Katli", link: "sweet/s9.php", image: "../food_image/sweet/kaju_katli.jpg" };

...
<title>Soan Papdi | Foodies</title>
<style>
/* Same CSS as Gajar Halwa page */
...
<div class="container">
  ...
  <h1>Soan Papdi</h1>
  <div class="food-img">
<img src="/food_recipe/food_image/swt/sw7.webp" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="sw7">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>Almonds for garnish</li>
    </ul>
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಬೇಳೆ ಹಿಟ್ಟು</li>
      <li>1 ಕಪ್ ಸಕ್ಕರೆ</li>
      <li>1/2 ಕಪ್ ghe</li>
      <li>1/4 ಕಪ್ ನೀರು</li>
      <li>1/4 ಟೀಸ್ಪೂನ್ ಏಲಕ್ಕಿ ಪುಡಿ</li>
      <li>ಆಲ್ಮಂಡ್ ಗಾರ್ನಿಶ್‌ಗೆ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Soan Papdi</h2>
    <h2 data-lang="kn" style="display:none;">ಸೋನ್ ಪಾಪ್ಡಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat ghee in a pan and roast besan until aromatic.</li>
      <li>Add sugar syrup and cardamom powder.</li>
      <li>Mix well and let it cool slightly.</li>
      <li>Stretch and fold mixture to get flaky texture.</li>
      <li>Cut into squares and garnish with almonds.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಪ್ಯಾನ್‌ನಲ್ಲಿ ghe ಹಿಟ್ಟನ್ನು ರೋಸ್ಟ್ ಮಾಡಿ.</li>
      <li>ಸಕ್ಕರೆ ಸಿರಪ್ ಮತ್ತು ಏಲಕ್ಕಿ ಪುಡಿ ಸೇರಿಸಿ.</li>
      <li>ಚೆನ್ನಾಗಿ ಕಲಸಿ ಸ್ವಲ್ಪ ತಂಪಾದಂತೆ ಬಿಡಿ.</li>
      <li>ಮಿಶ್ರಣವನ್ನು ಎಳೆದು ಸುತ್ತಿಸಿ ಫ್ಲಾಕಿ ಟೆಕ್ಸ್ಚರ್ ಪಡೆಯಿರಿ.</li>
      <li>ಚೌಕಗಳಾಗಿ ಕತ್ತರಿಸಿ ಆಲ್ಮಂಡ್ಗಳಿಂದ ಗಾರ್ನಿಷ್ ಮಾಡಿ.</li>
    </ol>
    ...
    <table data-lang="en">
      ...
      <tr><td>Sodium</td><td>30 mg</td></tr>
    </table>
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಸೋಡಿಯಂ</td><td>30 mg</td></tr>
    </table>
...
<script>
  ...
  const recipeData = { id: 103, name: "Soan Papdi", link: "sweet/s7.php", image: "../food_image/sweet/soan_papdi.jpg" };

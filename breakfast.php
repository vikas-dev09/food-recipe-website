...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    /* Header styles with logo and navigation */
    .land {
      width: 100%;
      height: 100px;
...
<body>
  ...
  <div class="land">
    ...
    // Show loader
    function showLoader() { loader.clas
...
<div class="grid-container">
  <div class="card">
    <img src="food_image/break/bk1.webp" alt="Idli" />
    <div class="card-body">
      <h5 class="card-title">Idli</h5>
      <p class="card-text">Soft and fluffy steamed rice cakes, a South Indian breakfast staple.</p>
      <a href="breakfast/b1.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/break/bk2.jpg" alt="Dosa" />
    <div class="card-body">
      <h5 class="card-title">Dosa</h5>
      <p class="card-text">Crispy rice and lentil crepe, served with chutney and sambar.</p>
      <a href="breakfast/b2.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/break/bk3.jpeg" alt="Upma" />
    <div class="card-body">
      <h5 class="card-title">Upma</h5>
      <p class="card-text">Savory semolina porridge cooked with spices and vegetables.</p>
      <a href="breakfast/b3.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/break/bk4.jpg" alt="Poha" />
    <div class="card-body">
      <h5 class="card-title">Poha</h5>
      <p class="card-text">Flattened rice cooked with turmeric, onions, and mild spices.</p>
      <a href="breakfast/b4.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/break/bk5.jpeg" alt="Paratha" />
    <div class="card-body">
      <h5 class="card-title">Paratha</h5>
      <p class="card-text">Stuffed flatbread with fillings like potato or cauliflower.</p>
      <a href="breakfast/b5.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/break/bk6.jpeg" alt="Puri Bhaji" />
    <div class="card-body">
      <h5 class="card-title">Puri Bhaji</h5>
      <p class="card-text">Fluffy deep-fried puris served with spiced potato curry.</p>
      <a href="breakfast/b6.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/break/bk7.jpg" alt="Chole Bhature" />
    <div class="card-body">
      <h5 class="card-title">Chole Bhature</h5>
      <p class="card-text">Spicy chickpea curry with fluffy deep-fried bread, popular in North India.</p>
      <a href="breakfast/b7.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/break/bk8.webp" alt="Medu Vada" />
    <div class="card-body">
      <h5 class="card-title">Medu Vada</h5>
      <p class="card-text">Crispy savory lentil doughnuts, often served with sambar.</p>
      <a href="breakfast/b8.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/break/bk9.jpeg" alt="Masala Dosa" />
    <div class="card-body">
      <h5 class="card-title">Masala Dosa</h5>
      <p class="card-text">Crispy dosa stuffed with spiced potato filling, served with chutney.</p>
      <a href="breakfast/b9.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/break/bk10.jpg" alt="Uttapam" />
    <div class="card-body">
      <h5 class="card-title">Uttapam</h5>
      <p class="card-text">Thick rice-lentil pancake topped with vegetables and spices.</p>
      <a href="breakfast/b10.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/break/bk11.jpeg" alt="Sabudana Khichdi" />
    <div class="card-body">
      <h5 class="card-title">Sabudana Khichdi</h5>
      <p class="card-text">Tapioca pearls stir-fried with peanuts and mild spices.</p>
      <a href="breakfast/b11.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/break/bk12.jpg" alt="Moong Dal Chilla" />
    <div class="card-body">
      <h5 class="card-title">Moong Dal Chilla</h5>
      <p class="card-text">Savory lentil pancakes, high in protein and easy to digest.</p>
      <a href="breakfast/b12.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/break/bk13.jpg" alt="Pav Bhaji" />
    <div class="card-body">
      <h5 class="card-title">Pav Bhaji</h5>
      <p class="card-text">Spiced vegetable mash served with buttered buns, a Mumbai favorite.</p>
      <a href="breakfast/b13.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/break/bk14.webp" alt="Aloo Sandwich" />
    <div class="card-body">
      <h5 class="card-title">Aloo Sandwich</h5>
      <p class="card-text">Spiced mashed potato filling sandwiched between bread slices.</p>
      <a href="breakfast/b14.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/break/bk15.jpg" alt="Dhokla" />
    <div class="card-body">
      <h5 class="card-title">Dhokla</h5>
      <p class="card-text">Steamed savory cake made from fermented gram flour.</p>
      <a href="breakfast/b15.php" class="view-btn">View Recipe</a>
    </div>
  </div>

  <div class="card">
    <img src="food_image/break/bk16.jpg" alt="Appam" />
    <div class="card-body">
      <h5 class="card-title">Appam</h5>
      <p class="card-text">Soft and fluffy rice pancake with a crispy edge, popular in Kerala.</p>
      <a href="breakfast/b16.php" class="view-btn">View Recipe</a>
    </div>
  </div>
</div>
  <!-- Footer -->
 ...
 "sandesh": "sweet/s11.php",9
 "malpua": "sweet/s12.php",
 "peda": "sweet/s13.php",
 "rabri": "sweet/s14.php",
 "modak": "sweet/s15.php",
 "payasam": "sweet/s16.php"sList.remove('hidden'); }
    ...
    input.addEventListener('input', () => {
      ...
      const matches = Object.keys(recipes)
        ...
        .slice(0,8);
      if (matches.length > 0) {
        sugg.innerHTML = matches.map((name, idx) =>

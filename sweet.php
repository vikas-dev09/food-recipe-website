...
<head>
  ...
  <title>Foodies - Indian Sweets</title>
  <!-- Google Fonts -->
...
<div class="land">
    ...
    <div class="nav-section">
      ...
      <div class="search-wrap">
        <div class="search-box">
          <input id="searchInput" type="text" autocomplete="off" placeholder="Search sweet recipes (try: gulab jamun)" />
  ...
  <!-- INDIAN SWEET RECIPE CARDS -->
  <div class="grid-container">

    <div class="card">
      <img src="food_image/swt/sw1.jpeg" alt="Gulab Jamun" />
      <div class="card-body">
        <h5 class="card-title">Gulab Jamun</h5>
        <p class="card-text">Soft milk-based dumplings soaked in rose-flavored syrup.</p>
        <a href="sweet/s1.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/swt/sw2.jpg" alt="Jalebi" />
      <div class="card-body">
        <h5 class="card-title">Jalebi</h5>
        <p class="card-text">Crispy, spiral-shaped sweets dipped in saffron sugar syrup.</p>
        <a href="sweet/s2.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/swt/sw3.jpg" alt="Rasgulla" />
      <div class="card-body">
        <h5 class="card-title">Rasgulla</h5>
        <p class="card-text">Spongy cheese balls soaked in light sugar syrup.</p>
        <a href="sweet/s3.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/swt/sw4.webp" alt="Rasmalai" />
      <div class="card-body">
        <h5 class="card-title">Rasmalai</h5>
        <p class="card-text">Soft cheese patties served in cardamom-scented milk.</p>
        <a href="sweet/s4.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/swt/sw5.webp" alt="Kheer" />
      <div class="card-body">
        <h5 class="card-title">Kheer</h5>
        <p class="card-text">Creamy rice pudding made with milk, nuts, and saffron.</p>
        <a href="sweet/s5.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/swt/sw6.jpg" alt="Gajar Halwa" />
      <div class="card-body">
        <h5 class="card-title">Gajar Halwa</h5>
        <p class="card-text">Carrot dessert cooked with milk, sugar, and ghee.</p>
        <a href="sweet/s6.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/swt/sw7.webp" alt="Soan Papdi" />
      <div class="card-body">
        <h5 class="card-title">Soan Papdi</h5>
        <p class="card-text">Flaky, melt-in-mouth sweet made with gram flour and sugar.</p>
        <a href="sweet/s7.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/swt/sw8.webp" alt="Besan Ladoo" />
      <div class="card-body">
        <h5 class="card-title">Besan Ladoo</h5>
        <p class="card-text">Gram flour balls roasted in ghee and flavored with cardamom.</p>
        <a href="sweet/s8.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/swt/sw9.jpg" alt="Kaju Katli" />
      <div class="card-body">
        <h5 class="card-title">Kaju Katli</h5>
        <p class="card-text">Diamond-shaped cashew fudge with silver leaf decoration.</p>
        <a href="sweet/s9.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/swt/sw10.avif" alt="Motichoor Ladoo" />
      <div class="card-body">
        <h5 class="card-title">Motichoor Ladoo</h5>
        <p class="card-text">Tiny gram flour pearls bound in saffron syrup and ghee.</p>
        <a href="sweet/s10.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/swt/sw11.jpg" alt="Sandesh" />
      <div class="card-body">
        <h5 class="card-title">Sandesh</h5>
        <p class="card-text">Bengali sweet made with fresh chenna and sugar.</p>
        <a href="sweet/s11.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/swt/sw12.webp" alt="Malpua" />
      <div class="card-body">
        <h5 class="card-title">Malpua</h5>
        <p class="card-text">Fried pancakes soaked in sugar syrup and topped with rabri.</p>
        <a href="sweet/s12.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/swt/sw13.jpg" alt="Peda" />
      <div class="card-body">
        <h5 class="card-title">Peda</h5>
        <p class="card-text">Soft milk-based fudge often flavored with cardamom.</p>
        <a href="sweet/s13.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/swt/sw14.jpg" alt="Rabri" />
      <div class="card-body">
        <h5 class="card-title">Rabri</h5>
        <p class="card-text">Thickened sweetened milk topped with saffron and pistachios.</p>
        <a href="sweet/s14.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/swt/sw15.jpg" alt="Modak" />
      <div class="card-body">
        <h5 class="card-title">Modak</h5>
        <p class="card-text">Steamed dumpling filled with coconut and jaggery, loved by Lord Ganesha.</p>
        <a href="sweet/s15.php" class="view-btn">View Recipe</a>
      </div>
    </div>

    <div class="card">
      <img src="food_image/swt/sw16.jpg" alt="Payasam" />
      <div class="card-body">
        <h5 class="card-title">Payasam</h5>
        <p class="card-text">South Indian sweet pudding made with rice, jaggery, and coconut milk.</p>
        <a href="sweet/s16.php" class="view-btn">View Recipe</a>
      </div>
    </div>

...
<title>Kashmiri Pulao | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Kashmiri Pulao</h1>
  <div class="food-img">
  <img src="/food_recipe/food_image/dinner/dn15.jpg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="dn15">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>1/4 cup nuts (cashews, almonds)</li>
      <li>1/4 cup dry fruits (raisins, apricots)</li>
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>1/4 ಕಪ್ ಬೇಳೆ (ಕಾಜೂ, ಬಾದಾಮ್)</li>
      <li>1/4 ಕಪ್ ಒಣ ಹಣ್ಣು (ಅಂಗೂರು, ಖುರ್ಸ)</li>
      <li>1 ಟೀ ಸ್ಪೂನ್ ಕೇಸರಿ</li>
      <li>2 ಟೇಬಲ್ ಸ್ಪೂನ್ ಘೀ</li>
      <li>2 ಕಪ್ ನೀರು</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ ತಕ್ಕಷ್ಟು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Kashmiri Pulao</h2>
    <h2 data-lang="kn" style="display:none;">ಕಾಶ್ಮಿರಿ ಪುಲಾವ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat ghee, fry nuts and dry fruits until golden.</li>
      <li>Add water, saffron, and salt. Bring to boil.</li>
      <li>Add rice, cook on low heat until water is absorbed.</li>
      <li>Fluff rice gently and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಘೀ ಬಿಸಿ ಮಾಡಿ ಬೇಳೆ ಮತ್ತು ಒಣ ಹಣ್ಣು ಬಂಗಾರದ ಬಣ್ಣ ಬರುವವರೆಗೆ ಹುರಿಯಿರಿ.</li>
      <li>ನೀರು, ಕೇಸರಿ, ಉಪ್ಪು ಸೇರಿಸಿ ಕುದಿಸಿ.</li>
      <li>ಅಕ್ಕಿ ಸೇರಿಸಿ ನೀರು ಕಡಿಮೆ ಆಗುವವರೆಗೆ ಬಿಸಿ ಮಾಡಿ.</li>
      <li>ಅಕ್ಕಿಯನ್ನು ಎದೆಗೆ ತಳ್ಳುವಂತೆ ಕಲಸಿ ಬಿಸಿ ಬಿಸಿ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 265, name: "Kashmiri Pulao", link: "dinner/d15.php", image: "../food_image/rice/kashmiri_pulao.jpg" };

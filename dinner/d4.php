...
<title>Tamarind Rice | Foodies</title>
<style>
...
<div class="container">
  ...
  <div class="food-img">
  <img src="/food_recipe/food_image/dinner/dn4.jpg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="dn4">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಹುಣಸೆ ಹಣ್ಣು ಪೇಸ್ಟ್</li>
      <li>1 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಎಣ್ಣೆ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಸಾಸಿವೆ</li>
      <li>1 ಒಣ ಮೆಣಸು</li>
      <li>10 ಕರಿಬೇವು ಎಲೆಗಳು</li>
      <li>1/4 ಟೀಸ್ಪೂನ್ ಹಸಿಮೆಣಸು</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Tamarind Rice</h2>
    <h2 data-lang="kn" style="display:none;">ಹುಣಸೆ ಅಕ್ಕಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat oil, add mustard seeds, dried chili, curry leaves, and turmeric; sauté for a minute.</li>
      <li>Add tamarind paste and cook for 2 minutes.</li>
      <li>Add cooked rice, mix well, and season with salt.</li>
      <li>Cook for 3-4 minutes until flavors blend.</li>
      <li>Garnish with coriander and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ, ಸಾಸಿವೆ, ಒಣ ಮೆಣಸು, ಕರಿಬೇವು ಮತ್ತು ಹಸಿಮೆಣಸು ಹಾಕಿ ಒಂದು ನಿಮಿಷ ಹುರಿಯಿರಿ.</li>
      <li>ಹುಣಸೆ ಪೇಸ್ಟ್ ಸೇರಿಸಿ 2 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಬೇಯಿಸಿದ ಅಕ್ಕಿ ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಮಿಶ್ರಣ ಮಾಡಿ ಮತ್ತು ಉಪ್ಪು ಹಾಕಿ.</li>
      <li>3-4 ನಿಮಿಷ ಬೇಯಿಸಿ, ರುಚಿ ಸೇರಿಸಲು ಬಿಡಿ.</li>
      <li>ಕೊತ್ತಂಬರಿ ಸೊಪ್ಪಿನಿಂದ ಅಲಂಕರಿಸಿ ಬಿಸಿ ಬಿಸಿ ಸೇವಿಸಿ.</li>
    </ol>
    ...
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಕಾರ್ಬೊಹೈಡ್ರೇಟ್</td><td>42 g</td></tr>
...
<script>
  ...
  const recipeData = { id: 204, name: "Tamarind Rice", link: "dinner/d4.php", image: "../food_image/rice/tamarind_rice.jpg" };

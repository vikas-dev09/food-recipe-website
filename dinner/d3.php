...
<div class="container">
  ...
  <div class="food-img">
  <img src="/food_recipe/food_image/dinner/dn3.jpeg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="dn3">  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>2 ಕಪ್ ನೀರು</li>
      <li>1 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಎಣ್ಣೆ ಅಥವಾ ತುಪ್ಪ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಜೀರಿಗೆ</li>
      <li>1 ಈರುಳ್ಳಿ, ಸ್ಲೈಸ್ ಮಾಡಿದ</li>
      <li>ಮಿಶ್ರಿತ ತರಕಾರಿಗಳು (ಕ್ಯಾರಟ್,ಬೀನ್ಸ್,ಪೀಸ್) - 1 ಕಪ್</li>
      <li>ಉಪ್ಪು ಮತ್ತು ಮಸಾಲೆಗಳು ರುಚಿಗೆ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Pulao</h2>
    <h2 data-lang="kn" style="display:none;">ಪಲಾವ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Rinse rice and soak for 20 minutes.</li>
      <li>Heat oil, add cumin seeds and onions; sauté until golden.</li>
      <li>Add vegetables, rice, water, salt, and spices.</li>
      <li>Cover and cook until rice is fluffy and water absorbed.</li>
      <li>Garnish with coriander and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಅಕ್ಕಿಯನ್ನು ತೊಳೆದು 20 ನಿಮಿಷ ನೆನೆಸಿ.</li>
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ, ಜೀರಿಗೆ ಮತ್ತು ಈರುಳ್ಳಿ ಹಾಕಿ ಹಣ್ಣಿನ ಬಣ್ಣ ಬರುವವರೆಗೆ ಹುರಿಯಿರಿ.</li>
      <li>ತರಕಾರಿಗಳು, ಅಕ್ಕಿ, ನೀರು, ಉಪ್ಪು ಮತ್ತು ಮಸಾಲೆ ಸೇರಿಸಿ.</li>
      <li>ಮೂರು ಮುಚ್ಚಿ ಅಕ್ಕಿ ಮೃದುವಾಗುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
...
<script>
  ...
  const recipeData = { id: 203, name: "Pulao", link: "dinner/d3.php", image: "../food_image/rice/pulao.jpg" };

...
<title>Coconut Rice | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Coconut Rice</h1>
  <div class="food-img">
  <img src="/food_recipe/food_image/dinner/dn9.jpeg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="dn9">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ol data-lang="en">
      <li>Mix grated coconut, green chili, ginger, and salt with cooked rice.</li>
      <li>Prepare tempering: heat oil, add mustard seeds, curry leaves, dried chili.</li>
      <li>Pour tempering over rice and mix gently.</li>
      <li>Add roasted cashews and garnish with coriander leaves.</li>
      <li>Serve warm or at room temperature.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ತುರಿದ ತೆಂಗಿನಕಾಯಿ, ಹಸಿಮೆಣಸು, ಶುಂಠಿ ಮತ್ತು ಉಪ್ಪು ಬೇಯಿಸಿದ ಅಕ್ಕಿಗೆ ಸೇರಿಸಿ ಕಲಸಿ.</li>
      <li>ತುಂಬು ಮಾಡಿ: ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ, ಆವಕಾಯಿ ಬೀಜ, ಕರಿಬೇವು, ಒಣ ಮೆಣಸು ಸೇರಿಸಿ.</li>
      <li>ತುಂಬುವ ಮಿಶ್ರಣವನ್ನು ಅಕ್ಕಿಗೆ ಹಾಕಿ ನಿಧಾನವಾಗಿ ಕಲಸಿ.</li>
      <li>ಹುರಿದ ಕ್ಯಾಜು ಸೇರಿಸಿ, ಕೊತ್ತಂಬರಿ ಎಲೆಗಳಿಂದ ಅಲಂಕಾರ ಮಾಡಿ.</li>
      <li>ಬಿಸಿ ಅಥವಾ ಕೋಣೆಯ ತಾಪಮಾನದಲ್ಲಿ ಸೇವಿಸಿ.</li>
    </ol>
...
const recipeData={id:258,name:"Coconut Rice",link:"dinner/d9.php",image:"../food_image/south/coconut_rice.jpg"};

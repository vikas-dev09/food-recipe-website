...
<div class="container">
  ...
  <div class="food-img">
  <img src="/food_recipe/food_image/dinner/dn16.jpeg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="dn16">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಅಕ್ಕಿ</li>
      <li>1/2 ಕಪ್ ಹಸಿರು ಬೇಳೆ</li>
      <li>2 ಕಪ್ ನೀರು</li>
      <li>1 ಟೇಬಲ್‌ಸ್ಪೂನ್ ತುಪ್ಪ</li>
      <li>ರುಚಿಗೆ ತಕ್ಕ ಉಪ್ಪು</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಅರಿಶಿನ</li>
    </ul>

    <h2 data-lang="en">Steps to Make Khichdi</h2>
    <h2 data-lang="kn" style="display:none;">ಖಿಚ್ಡಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Rinse rice and dal together.</li>
      <li>Heat ghee in a pressure cooker, add turmeric and salt.</li>
      <li>Add rice, dal, and water.</li>
      <li>Pressure cook for 3-4 whistles.</li>
      <li>Serve hot with ghee or curd.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಅಕ್ಕಿ ಮತ್ತು ಬೇಳೆ ಒಟ್ಟಿಗೆ ತೊಳೆದು ತೊಳೆದುಕೊಳ್ಳಿ.</li>
      <li>ಪ್ರೆಶರ್ ಕುಕ್ಕರ್‌ನಲ್ಲಿ ತುಪ್ಪ ಬಿಸಿ ಮಾಡಿ, ಅರಿಶಿನ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ.</li>
      <li>ಅಕ್ಕಿ, ಬೇಳೆ ಮತ್ತು ನೀರು ಸೇರಿಸಿ.</li>
      <li>3–4 ಸಿಟಿ ಬರುವವರೆಗೆ ಬೇಯಿಸಿ.</li>
      <li>ತುಪ್ಪ ಅಥವಾ ಮೊಸರಿನೊಂದಿಗೆ ಬಿಸಿ ಬಿಸಿ ಸೇವಿಸಿ.</li>
    </ol>
    ...
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಕಾರ್ಬೊಹೈಡ್ರೇಟ್</td><td>28 g</td></tr>
...
<script>
  ...
  const recipeData = { id: 268, name: "Khichdi", link: "dinner/d16.php", image: "../food_image/rice/khichdi.jpg" };

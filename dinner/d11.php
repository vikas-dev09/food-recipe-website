...
<title>Paneer Pulao | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Paneer Pulao</h1>
  <div class="food-img">
  <img src="/food_recipe/food_image/dinner/dn11.jpeg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="dn11">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>100 ಗ್ರಾಂ ಪನೀರ್ (ಚೌಕಾಕಾರದಲ್ಲಿ)</li>
      <li>1 ಈರುಳ್ಳಿ (ಸ್ಲೈಸ್ ಮಾಡಿದ)</li>
      <li>1/2 ಕಪ್ ಹರಿ ಬಟಾಣಿ</li>
      <li>1 ಟೀ ಸ್ಪೂನ್ ಜೀರಿಗೆ</li>
      <li>2 ಟೇಬಲ್ ಸ್ಪೂನ್ ಎಣ್ಣೆ ಅಥವಾ ಘೀ</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ ತಕ್ಕಷ್ಟು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Paneer Pulao</h2>
    <h2 data-lang="kn" style="display:none;">ಪನೀರ್ ಪುಲಾವ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Wash and soak rice for 20 minutes.</li>
      <li>Heat oil, add cumin seeds and onions until golden.</li>
      <li>Add paneer cubes, peas, and sauté for 2-3 minutes.</li>
    ...
    <ol data-lang="kn" style="display:none;">
      ...
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ, ಜೀರಿಗೆ ಮತ್ತು ಈರುಳ್ಳಿ ಬಂಗಾರದ ಬಣ್ಣ ಬರುವವರೆಗೆ ಹುರಿಯಿರಿ.</li>
      <li>ಪನೀರ್ ಚೌಕಾಕಾರಗಳು, ಬಟಾಣಿ ಸೇರಿಸಿ 2-3 ನಿಮಿಷ ಹುರಿಯಿರಿ.</li>
...
<script>
  ...
  const recipeData = { id: 261, name: "Paneer Pulao", link: "dinner/d11.php", image: "../food_image/rice/paneer_pulao.jpg" };

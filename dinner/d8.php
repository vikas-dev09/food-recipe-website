...
<title>Sambar Rice | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Sambar Rice</h1>
  <div class="food-img">
  <img src="/food_recipe/food_image/dinner/dn8.jpeg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="dn8">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>1/2 cup cooked toor dal</li>
      <li>1 cup tamarind extract</li>
      <li>1/2 tsp turmeric, salt to taste</li>
      <li>Sambar vegetables: carrot, drumstick, beans</li>
      <li>Tempering: 1 tsp oil, mustard seeds, curry leaves, dried red chili</li>
      <li>Coriander leaves for garnish</li>
    </ul>
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಬೇಯಿಸಿದ ಅಕ್ಕಿ</li>
      <li>1/2 ಕಪ್ ಬೇಯಿಸಿದ ತೋರ್ ಬೇಳೆ</li>
      <li>1 ಕಪ್ ಹುಳಿ ರಸ</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಅರಿಶಿನ, ಉಪ್ಪು ರುಚಿಗೆ</li>
      <li>ಸಾಂಬಾರ್ ತರಕಾರಿಗಳು: ಗಾಜರ್, ದುಂಡೆಹಣ್ಣು, ಬೀನ್ಸ್</li>
      <li>ತುಂಬು: 1 ಟೀಸ್ಪೂನ್ ಎಣ್ಣೆ, ಆವಕಾಯಿ ಬೀಜ, ಕರಿಬೇವು, ಒಣ ಮೆಣಸು</li>
    ...
    <ol data-lang="en">
      <li>Mix cooked dal with tamarind extract, turmeric, and salt.</li>
      <li>Add vegetables and cook until tender.</li>
      <li>Add cooked rice and mix gently.</li>
      <li>Prepare tempering: heat oil, add mustard seeds, curry leaves, dried chili.</li>
      <li>Pour tempering over sambar rice, garnish with coriander, and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಬೇಯಿಸಿದ ಬೇಳೆಯನ್ನು ಹುಳಿ ರಸ, ಅರಿಶಿನ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ ಕಲಸಿ.</li>
      <li>ತರಕಾರಿಗಳನ್ನು ಸೇರಿಸಿ ಸೊಗಸಾಗಿ ಬೇಯಿಸು.</li>
      <li>ಬೇಯಿಸಿದ ಅಕ್ಕಿಯನ್ನು ಸೇರಿಸಿ ನಿಧಾನವಾಗಿ ಕಲಸಿ.</li>
      <li>ತುಂಬು ಮಾಡಿ: ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ, ಆವಕಾಯಿ ಬೀಜ, ಕರಿಬೇವು, ಒಣ ಮೆಣಸು ಸೇರಿಸಿ.</li>
      <li>ತುಂಬುವ ಮಿಶ್ರಣವನ್ನು ಸಾಂಬಾರ್ ಅಕ್ಕಿಗೆ ಹಾಕಿ, ಕೊತ್ತಂಬರಿ ಅಲಂಕಾರ ಮಾಡಿ ಬಿಸಿ ಬಿಸಿ ಸೇವಿಸಿ.</li>
    </ol>
...
const recipeData={id:257,name:"Sambar Rice",link:"dinner/d8.php",image:"../food_image/south/sambar_rice.jpg"};

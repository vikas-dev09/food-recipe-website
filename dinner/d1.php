...
<title>Veg Biryani | Foodies</title>
<style>
...
<div class="container">
  ...
  <div class="food-img">
<img src="/food_recipe/food_image/dinner/dn1.jpg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="dn1">  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>1 cup mixed vegetables (carrot, beans, peas)</li>
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಬಾಸ್ಮತಿ ಅಕ್ಕಿ</li>
      <li>1 ಕಪ್ ಮಿಶ್ರಿತ ತರಕಾರಿಗಳು (ಗರಣಿ, ಬೀನ್, ಮಟರ್)</li>
      <li>1 ಈರುಳ್ಳಿ, ಚಿಪ್ಸು</li>
      <li>1 ಟೊಮೇಟೋ, ಚೀರಿದ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಎಣ್ಣೆ ಅಥವಾ ತುಪ್ಪ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಶುಂಠಿ-ಬೆಳ್ಳುಳ್ಳಿ ಪೇಸ್ಟ್</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಬಿರಿಯಾನಿ ಮಸಾಲೆ</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಹಸಿಮೆಣಸು</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ</li>
      <li>2 ಕಪ್ ನೀರು</li>
      <li>ಹಸಿರು ಕೊತ್ತಂಬರಿ ಮತ್ತು ಪುದೀನಾ ಎಲೆಗಳು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Veg Biryani</h2>
    <h2 data-lang="kn" style="display:none;">ವೇಜ್ ಬಿರಿಯಾನಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Wash rice and soak for 30 minutes.</li>
      <li>Heat oil/ghee, sauté onions until golden, add ginger-garlic paste, tomatoes, and vegetables.</li>
      <li>Add turmeric, biryani masala, salt, and cook for 5 minutes.</li>
      <li>Add rice and water, cover and cook until rice is done.</li>
      <li>Garnish with coriander and mint leaves. Serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಅಕ್ಕಿ ತೊಳಸಿ 30 ನಿಮಿಷ ನೆನೆಸಿ.</li>
      <li>ಎಣ್ಣೆ/ತುಪ್ಪ ಬಿಸಿ ಮಾಡಿ, ಈರುಳ್ಳಿ ಬಂಗಾರದ ಬಣ್ಣಕ್ಕೆ ಹುರಿಯಿರಿ, ಶುಂಠಿ-ಬೆಳ್ಳುಳ್ಳಿ ಪೇಸ್ಟ್, ಟೊಮೇಟೋ ಮತ್ತು ತರಕಾರಿಗಳು ಸೇರಿಸಿ.</li>
      <li>ಹಸಿಮೆಣಸು, ಬಿರಿಯಾನಿ ಮಸಾಲೆ, ಉಪ್ಪು ಸೇರಿಸಿ 5 ನಿಮಿಷ ಹುರಿಯಿರಿ.</li>
      <li>ಅಕ್ಕಿ ಮತ್ತು ನೀರು ಸೇರಿಸಿ, ಮುಚ್ಚಿ ಅಕ್ಕಿ ಚೆನ್ನಾಗಿ ಬೇಯಿಸಿ.</li>
      <li>ಕೊತ್ತಂಬರಿ ಮತ್ತು ಪುದೀನ ಎಲೆಗಳಿಂದ ಅಲಂಕರಿಸಿ ಬಿಸಿ ಬಿಸಿ ಸೇವಿಸಿ.</li>
    </ol>
    ...
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಕಾರ್ಬೊಹೈಡ್ರೇಟ್</td><td>55 g</td></tr>
...
<script>
  ...
  const recipeData = { id: 301, name: "Veg Biryani", link: "dinner/d1.php", image: "../food_image/biryani/veg_biryani.jpg" };

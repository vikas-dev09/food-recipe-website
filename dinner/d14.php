...
<title>Spinach Rice | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Spinach Rice</h1>
  <div class="food-img">
  <img src="/food_recipe/food_image/dinner/dn14.jpeg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="dn14">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      <li>1 cup rice</li>
      <li>1 cup spinach, finely chopped</li>
    ...
    <ul data-lang="kn" style="display:none;">
      <li>1 ಕಪ್ ಅಕ್ಕಿ</li>
      <li>1 ಕಪ್ ಪಲಕ್, ಸಣ್ಣದಾಗಿ ಕತ್ತರಿಸಿದ</li>
      <li>1 ಈರುಳ್ಳಿ, ಕತ್ತರಿಸಿದ</li>
      <li>2 ಬೆಳ್ಳುಳ್ಳಿ ಹಣ್ಣು, ಸುಪ್ಪಿಸಿದ</li>
      <li>1 ಟೀಸ್ಪೂನ್ ಜೀರಿಗೆ</li>
      <li>1/2 ಟೀಸ್ಪೂನ್ ಹಳದಿ ಪುಡಿ</li>
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ಎಣ್ಣೆ</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ</li>
      <li>ಅವಶ್ಯಕತೆ ಇದ್ದಷ್ಟು ನೀರು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Spinach Rice</h2>
    <h2 data-lang="kn" style="display:none;">ಪಲಕ್ ಅಕ್ಕಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Rinse rice and soak for 15-20 minutes.</li>
      <li>Heat oil in a pan, add cumin seeds and sauté onions and garlic until golden.</li>
      <li>Add chopped spinach, turmeric, and salt; cook for 3-4 minutes.</li>
      <li>Add rice and water (1:2 ratio), bring to a boil, then simmer until rice is cooked.</li>
      <li>Fluff rice with a fork and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಅಕ್ಕಿ ತೊಳಸಿ 15–20 ನಿಮಿಷ ನೆನೆಸಿಡಿ.</li>
      <li>ಪ್ಯಾನ್‌ನಲ್ಲಿ ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ, ಜೀರಿಗೆ ಸೇರಿಸಿ ಈರುಳ್ಳಿ ಮತ್ತು ಬೆಳ್ಳುಳ್ಳಿಯನ್ನು ಬಂಗಾರದ ಬಣ್ಣ ಬರುವವರೆಗೆ sauté ಮಾಡಿ.</li>
      <li>ಸಣ್ಣದಾಗಿ ಕತ್ತರಿಸಿದ ಪಲಕ್, ಹಳದಿ, ಉಪ್ಪು ಸೇರಿಸಿ 3–4 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಅಕ್ಕಿ ಮತ್ತು ನೀರು (1:2 ಅನುಪಾತ) ಸೇರಿಸಿ, ಕುದಿಸಿ ನಂತರ ಆವಶ್ಯಕತೆಯಷ್ಟು ಬೇಯಿಸಿ.</li>
      <li>ಅಕ್ಕಿಯನ್ನು ಕಡ್ಡಿಯೊಂದಿಗೆ ಹಚ್ಚಿ ಬಿಸಿ ಬಿಸಿ ಸೇವಿಸಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 279, name: "Spinach Rice", link: "dinner/b14.php", image: "../food_image/dinner/spinach_rice.jpg" };

...
<title>Veg Fried Rice | Foodies</title>
<style>
...
<div class="container">
  ...
  <div class="food-img">
  <img src="/food_recipe/food_image/dinner/dn13.jpeg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="bk13">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="en">
      ...
      <li>1 cup mixed vegetables (carrot, beans, capsicum)</li>
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>1 ಕಪ್ ಮಿಶ್ರಿತ ತರಕಾರಿಗಳು (ಗಾಜರ, ಬೀನ್ಸ್, ಕ್ಯಾಪ್ಸಿಕಮ್)</li>
      <li>1 ಈರುಳ್ಳಿ (ಚಾಪ್ ಮಾಡಿದ)</li>
      <li>2 ಟೇಬಲ್ ಸ್ಪೂನ್ ಸೋಯಾ ಸಾಸ್</li>
      <li>2 ಟೇಬಲ್ ಸ್ಪೂನ್ ಎಣ್ಣೆ</li>
      <li>ಉಪ್ಪು ಮತ್ತು ಮೆಣಸು ರುಚಿಗೆ ತಕ್ಕಷ್ಟು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Veg Fried Rice</h2>
    <h2 data-lang="kn" style="display:none;">ವೆಜ್ ಫ್ರೈಡ್ ರೈಸ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Heat oil in a pan and sauté onions until golden.</li>
      <li>Add mixed vegetables, cook for 5 minutes.</li>
      <li>Add cooked rice, soy sauce, salt, and pepper. Mix well.</li>
      <li>Cook for another 2-3 minutes and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ ಈರುಳ್ಳಿ ಬಂಗಾರದ ಬಣ್ಣ ಬರುವವರೆಗೆ ಹುರಿಯಿರಿ.</li>
      <li>ಮಿಶ್ರಿತ ತರಕಾರಿಗಳನ್ನು ಸೇರಿಸಿ 5 ನಿಮಿಷ ಬೇಯಿಸಿ.</li>
      <li>ಬೇಯಿಸಿದ ಅಕ್ಕಿ, ಸೋಯಾ ಸಾಸ್, ಉಪ್ಪು, ಮೆಣಸು ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಕಲಸಿ.</li>
      <li>ಮತ್ತೆ 2-3 ನಿಮಿಷ ಬೇಯಿಸಿ ಬಿಸಿ ಬಿಸಿ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>

    <h2 data-lang="en">Nutrition Information (per serving)</h2>
    <table data-lang="en">
      <tr><th>Nutrient</th><th>Amount</th></tr>
      <tr><td>Calories</td><td>310 kcal</td></tr>
...
<script>
  ...
  const recipeData = { id: 263, name: "Veg Fried Rice", link: "dinner/d13.php", image: "../food_image/rice/veg_fried_rice.jpg" };

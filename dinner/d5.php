...
<title>Lemon Rice | Foodies</title>
<style>
...
<div class="container">
  ...
  <div class="food-img">
  <img src="/food_recipe/food_image/dinner/dn5.jpeg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="dn5">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>2 ಟೇಬಲ್‌ಸ್ಪೂನ್ ನಿಂಬೆಹಣ್ಣು ಹಣ್ಣು ರಸ</li>
    ...
    <h2 data-lang="en">Steps to Make Lemon Rice</h2>
    <h2 data-lang="kn" style="display:none;">ನಿಂಬೆ ಅಕ್ಕಿ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      ...
      <li>Cook for 2-3 minutes, garnish with coriander leaves, and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ, ಸಾಸಿವೆ, ಒಣ ಮೆಣಸು, ಕರಿಬೇವು ಮತ್ತು ಹಸಿಮೆಣಸು ಹಾಕಿ ಒಂದು ನಿಮಿಷ ಹುರಿಯಿರಿ.</li>
      <li>ಬೇಯಿಸಿದ ಅಕ್ಕಿ ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ ನಿಧಾನವಾಗಿ ಕಲಸಿ.</li>
      <li>ನಿಂಬೆ ರಸ ಸೇರಿಸಿ ಚೆನ್ನಾಗಿ ಮಿಶ್ರಣ ಮಾಡಿ.</li>
      <li>2-3 ನಿಮಿಷ ಬೇಯಿಸಿ, ಕೊತ್ತಂಬರಿ ಸೊಪ್ಪಿನಿಂದ ಅಲಂಕರಿಸಿ ಬಿಸಿ ಬಿಸಿ ಸೇವಿಸಿ.</li>
    </ol>
    ...
    <table data-lang="kn" style="display:none;">
      ...
      <tr><td>ಕಾರ್ಬೊಹೈಡ್ರೇಟ್</td><td>40 g</td></tr>
...
<script>
  ...
  const recipeData = { id: 205, name: "Lemon Rice", link: "dinner/d5.php", image: "../food_image/rice/lemon_rice.jpg" };

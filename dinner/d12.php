...
<title>Mushroom Pulao | Foodies</title>
<style>
...
<div class="container">
  ...
  <h1>Mushroom Pulao</h1>
  <div class="food-img">
  <img src="/food_recipe/food_image/dinner/dn12.jpg" style="width: 300px; height: 300px; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 1.3);" alt="dn12">
  </div>
  ...
  <div id="recipe-content">
    ...
    <ul data-lang="kn" style="display:none;">
      ...
      <li>200 ಗ್ರಾಂ ಅಲ್ಯೂಂ ಬುಡಿಗಳನ್ನು (ಸ್ಲೈಸ್ ಮಾಡಿದ)</li>
      <li>1 ಈರುಳ್ಳಿ (ಸ್ಲೈಸ್ ಮಾಡಿದ)</li>
      <li>1/2 ಕಪ್ ಹರಿ ಬಟಾಣಿ</li>
      <li>1 ಟೀ ಸ್ಪೂನ್ ಜೀರೆ</li>
      <li>2 ಟೇಬಲ್ ಸ್ಪೂನ್ ಎಣ್ಣೆ ಅಥವಾ ಘೀ</li>
      <li>ಉಪ್ಪು ರುಚಿಗೆ ತಕ್ಕಷ್ಟು</li>
    </ul>

    <h2 data-lang="en">Steps to Make Mushroom Pulao</h2>
    <h2 data-lang="kn" style="display:none;">ಅಲ್ಯೂಂ ಪುಲಾವ್ ತಯಾರಿಸುವ ಹಂತಗಳು</h2>
    <ol data-lang="en">
      <li>Wash and soak rice for 20 minutes.</li>
      <li>Heat oil, add cumin seeds and onions until golden.</li>
      <li>Add mushrooms, peas, sauté for 3-4 minutes.</li>
      <li>Add rice, water (1.5 cups), and salt. Cook until done.</li>
      <li>Fluff rice and serve hot.</li>
    </ol>
    <ol data-lang="kn" style="display:none;">
      <li>ಅಕ್ಕಿಯನ್ನು ತೊಳೆಯಿರಿ ಮತ್ತು 20 ನಿಮಿಷ ನೆನೆಸಿ.</li>
      <li>ಎಣ್ಣೆ ಬಿಸಿ ಮಾಡಿ, ಜೀರೆ ಮತ್ತು ಈರುಳ್ಳಿ ಬಂಗಾರದ ಬಣ್ಣ ಬರುವವರೆಗೆ ಹುರಿಯಿರಿ.</li>
      <li>ಅಲ್ಯೂಂ, ಬಟಾಣಿ ಸೇರಿಸಿ 3-4 ನಿಮಿಷ ಹುರಿಯಿರಿ.</li>
      <li>ಅಕ್ಕಿ, ನೀರು (1.5 ಕಪ್), ಮತ್ತು ಉಪ್ಪು ಸೇರಿಸಿ ಬೇಯಿಸಿ.</li>
      <li>ಅಕ್ಕಿಯನ್ನು ಚೆನ್ನಾಗಿ ಮಿಶ್ರಿಸಿ ಬಿಸಿ ಬಿಸಿ ಸರ್ವ್ ಮಾಡಿ.</li>
    </ol>
...
<script>
  ...
  const recipeData = { id: 262, name: "Mushroom Pulao", link: "dinner/d12.php", image: "../food_image/rice/mushroom_pulao.jpg" };
